...
(function (a) {
    ...
    function b(a, b, e, p) {
        a.hasOwnProperty(b) || (a[b] = p.apply(null, e), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: b,
                module: a[b]
            }
    ...
    b(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        const {
            isSafari: b
        } = a, c = a.win, p = c.document, n = c.URL || c.webkitURL || c, C = a.dataURLtoBlob = function (a) {
        ...
        a = a.downloadURL = function (a, d) {
            ...
            if ("string" === typeof a || a instanceof String || !e.msSaveOrOpenBlob) {
                ...
                if (b && "string" === typeof a && 0 === a.indexOf("data:application/pdf") || e || 2E6 < a.length)
                    if (a = C(a) || "", !a) throw Error("Failed to convert to blob");
                if ("undefined" !== typeof n.download) n.href = a, n.download = d, p.body.appendChild(n), n.click(), p.body.removeChild(n);
                else try {
    ...
    b(a, "Extensions/ExportData/ExportData.js", [a["Core/Renderer/HTML/AST.js"], a["Extensions/ExportData/ExportDataDefaults.js"], a["Core/Globals.js"], a["Core/Defaults.js"], a["Extensions/DownloadURL.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, b, e, p, n, C, r) {
        function c() {
            ...
            O(P(a, "text/csv") || "data:text/csv,﻿" +
                encodeURIComponent(a), this.getFilename() + ".csv")
        }

        function d() {
            const a = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Ark1</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--><style>td{border:none;font-family: Calibri, sans-serif;} .number{mso-number-format:"0.00";} .text{ mso-number-format:"@";}</style><meta name=ProgId content=Excel.Sheet><meta charset=UTF-8></head><body>' +
                this.getTable(!0) + "</body></html>";
            O(P(a, "application/vnd.ms-excel") || "data:application/vnd.ms-excel;base64," + t.btoa(unescape(encodeURIComponent(a))), this.getFilename() + ".xls")
        }
        ...
        function U(a) {
            ...
            const c = this.getDataRows(),
                ...
                d = v(b.decimalPoint, "," !== b.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."),
                h = v(b.itemDelimiter, "," === d ? ";" : ","),
                e = b.lineDelimiter;
            c.forEach((a, b) => {
                let f, q = a.length;
                for (; q--;) f = a[q], "string" === typeof f && (f = '"' + f + '"'), "number" === typeof f && "." !== d &&
                    (f = f.toString().replace(".", d)), a[q] = f;
        ...
        function N(a) {
            ...
            this.series.forEach(function (f) {
                ...
                let y = p(f, q),
                    z, g;
                if (!1 !== f.options.includeInDataExport && !f.options.isInternal && !1 !== f.visible) {
                    X(A, function (a) {
                        return a[0] === E
                    }) || A.push([E, x]);
                    for (g = 0; g < D;) B = Q(f, q[g], q.length), F.push(B.columnTitle || B), a && n.push(B.topLevelColumnTitle || B), g++;
                    z = {
                        chart: f.chart,
                    ...
                    f.options.data.forEach(function (a, d) {
                        ...
                        m = w.x;
                        G(h[m]) && h[m].seriesIndices.includes(z.index) && (a = Object.keys(h).filter(a => h[a].seriesIndices.includes(z.index) && m).filter(a => 0 === a.indexOf(String(m))), m = m.toString() + "," + a.length);
                        a = f.data[d] && f.data[d].name;
                        g = 0;
                        if (!e || "name" === f.exportKey || !b && e && e.hasNames && a) m = a;
                        k && (k[m] && (m += "|" + d), k[m] = !0);
                        h[m] || (h[m] = [], h[m].xValues = []);
                        h[m].x = w.x;
                        h[m].name = a;
                        ...
                        for (h[m].seriesIndices = [...h[m].seriesIndices, z.index]; g < D;) d = q[g], a = w[d], h[m][x + g] = v(y.categoryMap[d][a], y.dateTimeValueAxisMap[d] ? c.dateFormat(l.dateFormat, a) : null, a), g++
                    });
                    x += g
                }
            });
            ...
            for (x = A.length; x--;) {
                ...
                e.forEach(function (a) {
                    let b = a.name;
                    k && !G(b) && (k.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), b = c.dateFormat(l.dateFormat, a.x)) : b = k.categories ? v(k.names[a.x], k.categories[a.x], a.x) : a.x);
                    a.splice(t, 0, b)
                })
            }
            g = g.concat(e);
        ...
        function Z(a) {
            ...
            const e = h ? a.shift() : null,
                ...
                p = function (a, b, c, d) {
                    ...
                    "number" === typeof e ? (e = e.toString(), "," === l && (e = e.replace(".", l)), b = "highcharts-number") : d || (b = "highcharts-empty");
                    c = R({
                        "class": b
                    }, c);
                    return {
            ...
            for (let c = 0, d = a.length; c < d; ++c) a[c].length > b && (b = a[c].length);
            c.push(function (a, b, c) {
                    ...
                    for (k = []; e < c; ++e) {
                        ...
                        g === q ?
                            ++f : f ? (k.push(p("th", "highcharts-table-topheading", {
                                scope: "col",
                                colspan: f + 1
                            }, g)), f = 0) : (g === b[e] ? d.exporting.useRowspanHeaders ? (q = 2, delete b[e]) : (q = 1, b[e] = "") : q = 1, g = p("th", "highcharts-table-topheading", {
                                scope: "col"
                            }, g), 1 < q && g.attributes && (g.attributes.valign = "top", g.attributes.rowspan = q), k.push(g))
                    }
                    l.push({
                        tagName: "tr",
                        children: k
                ...
                if (b) {
                    a = [];
                    e = 0;
                    for (c = b.length; e < c; ++e) "undefined" !== typeof b[e] && a.push(p("th", null, {
                        scope: "col"
                    }, b[e]));
                    l.push({
                        tagName: "tr",
                ...
                n, Math.max(b, n.length)));
            const g = [];
            a.forEach(function (a) {
                const c = [];
                for (let d = 0; d < b; d++) c.push(p(d ? "td" : "th", null, d ? {} : {
                    scope: "row"
                }, a[d]));
                g.push({
                    tagName: "tr",
        ...
        function ba(b) {
            ...
            c && (this.dataTableDiv = ca.createElement("div"), this.dataTableDiv.className =
                "highcharts-data-table", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
            if (this.dataTableDiv) {
                var d = this.dataTableDiv.style,
                    e = d.display;
                d.display = b ? "block" : "none";
                b && (this.dataTableDiv.innerHTML = a.emptyHTML, (new a([this.getTableAST()])).addToDOM(this.dataTableDiv), H(this, "afterViewData", {
            ...
            e = (d = this.options.exporting) && d.buttons && d.buttons.contextButton.menuItems;
            b = this.options.lang;
            d && d.menuItemDefinitions && b && b.viewData && b.hideData && e && c && (c = c[e.indexOf("viewData")]) && a.setElementHTML(c, this.isDataTableVisible ? b.hideData : b.viewData)
        }
        ...
        function P(a, b) {
            ...
            try {
                ...
                if (!d) return e.createObjectURL(new t.Blob(["﻿" +
                    a
                ], {
                    type: b
                }))
        ...
        function ea() {
            const a = this,
                ...
                c = (a, b) => (c, d) => {
                    ...
                    return "" === e || "" === c || isNaN(e) || isNaN(c) ? e.toString().localeCompare(c) : e - c
                };
            if (b && a.options.exporting && a.options.exporting.allowTableSorting) {
                const d = b.querySelector("thead tr");
                d && d.childNodes.forEach(d => {
                    const e = d.closest("table");
                    d.addEventListener("click", function () {
                        const l = [...b.querySelectorAll("tr:not(thead tr)")],
                            f = [...d.parentNode.children];
                        l.sort(c(f.indexOf(d), a.ascendingOrderInTable = !a.ascendingOrderInTable)).forEach(a => {
                            e.appendChild(a)
                        });
                        f.forEach(a => {
                            ["highcharts-sort-ascending", "highcharts-sort-descending"].forEach(b => {
                                a.classList.contains(b) && a.classList.remove(b)
                            })
                        });
                        d.classList.add(a.ascendingOrderInTable ? "highcharts-sort-ascending" : "highcharts-sort-descending")
                    })
                })
            }
        }
        ...
        return {
            compose: function (a) {
                r.pushUnique(u, a) && (T(a, "afterViewData", ea), T(a, "render", fa), a = a.prototype, a.downloadCSV = c, a.downloadXLS = d, a.getCSV = U, a.getDataRows = N, a.getTable = Y, a.getTableAST = Z, a.hideData = aa, a.toggleDataTable = ba, a.viewData = da);
                if (r.pushUnique(u, S)) {
                    ...
                    }), a.buttons && a.buttons.contextButton.menuItems && a.buttons.contextButton.menuItems.push("separator", "downloadCSV", "downloadXLS", "viewData");
                    S(b)
                }
                I && r.pushUnique(u, I) && (I.prototype.keyToAxis = {
                    low: "y",
                    high: "y"
                });
                J && r.pushUnique(u, J) && (J.prototype.keyToAxis = {
                    start: "x",
                    end: "x"
                });
                K && r.pushUnique(u, K) && (K.prototype.exportKey =
                    "name");
    ...
    b(a, "masters/modules/export-data.src.js", [a["Core/Globals.js"], a["Extensions/ExportData/ExportData.js"]], function (a, b) {
        b.compose(a.Chart)
    })
});