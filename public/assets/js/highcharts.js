...
(function (U, M) {
    ...
    M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
        function x(c, b, f, k) {
            ...
            const r = u(c);
            let e = r ? `${n} #${c}: www.highcharts.com/errors/${c}/` :
                c.toString();
        ...
        function F(c, b, f) {
            ...
            function d(f) {
                ...
                c.nodeName && (b ? (d = {}, d[b] = !0) : d = f, E(d, function (c, b) {
                    if (f[b])
                        for (K = f[b].length; K--;) n(b, f[b][K].fn)
                }))
            }
        ...
        E({
            ...
            a[b] = function (f) {
                ...
                return Array.prototype[c].apply(f, [].slice.call(arguments,
                    1))
            }
        });
        let b;
        ...
        G = {
            addEvent: function (c, b, f, d = {}) {
                ...
                n = n.hcEvents;
                a.Point &&
                    c instanceof a.Point && c.series && c.series.chart && (c.series.chart.runTrackerClick = !0);
            ...
            diffObjects: function (c, b, f, d) {
                function n(b, c, K, k) {
                    ...
                    E(b, function (f, q) {
                        ...
                        } else if (z(f, !0) && !f.nodeType) K[q] = C(f) ? [] : {}, n(f, c[q] || {}, K[q], k + 1), 0 !== Object.keys(K[q]).length || "colorAxis" === q && 0 === k || delete K[q];
            ...
            getClosestDistance: function (b, f) {
                ...
                b.forEach(b => {
                    if (1 < b.length)
                        for (q = n = b.length - 1; 0 < q; q--) k = b[q] - b[q - 1], 0 > k && !c ? (null === f || void 0 === f ? void 0 : f(), f = void 0) : k && ("undefined" === typeof d || k < d) && (d = k)
                });
                return d
            },
            getMagnitude: g,
            ...
            insertItem: function (b, f) {
                ...
                for (n = b.options.isInternal ? d : 0; n < d + 1; n++)
                    if (!f[n] || u(c) && c < m(f[n].options.index, f[n]._i) || f[n].options.isInternal) {
                        f.splice(n, 0,
                            b);
                        break
                    } return n
    ...
    M(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y) {
        ...
        class z {
            ...
            init(a) {
                let B;
                let u;
                if ("object" === typeof a && "undefined" !== typeof a.stops) this.stops = a.stops.map(l => new z(l[1]));
                else if ("string" === typeof a) {
                    this.input =
                        a = z.names[a.toLowerCase()] || a;
                    if ("#" === a.charAt(0)) {
                        var v = a.length;
                    ...
                    if (!B)
                        for (l = z.parsers.length; l-- && !B;) u = z.parsers[l], (v = u.regex.exec(a)) && (B = u.parse(v))
                }
                B && (this.rgba = B)
            }
            get(a) {
            ...
            brighten(a) {
                ...
                if (this.stops) this.stops.forEach(function (u) {
                    ...
                    for (let u = 0; 3 > u; u++) B[u] += C(255 * a), 0 > B[u] && (B[u] = 0), 255 < B[u] && (B[u] = 255);
                return this
            }
            setOpacity(a) {
                this.rgba[3] = a;
    ...
    M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y) {
        const {
            ...
            splat: p,
            timeUnits: t
        } = y, m = a.isSafari && x.Intl && x.Intl.DateTimeFormat.prototype.formatRange, h = a.isSafari && x.Intl && !x.Intl.DateTimeFormat.prototype.formatRange;
        class g {
            constructor(e) {
                this.options = {};
            ...
            update(e = {}) {
                ...
                this.getTimezoneOffset = this.timezoneOffsetFunction();
                this.variableTimezone = g && !(!e.getTimezoneOffset &&
                    !e.timezone)
            }
            ...
            getTimeTicks(e, g, h, m) {
                ...
                if (L(g)) {
                    ...
                    w >= t.day && d.set("Date", q, w >= t.month ? 1 : Math.max(1, b * Math.floor(d.get("Date",
                        q) / b)));
                    if (w >= t.month) {
                    ...
                    g = q.getTime();
                    for (q = 1; g < h;) k.push(g), g = w === t.year ? d.makeTime(c + q * b, 0) : w ===
                        t.month ? d.makeTime(c, m + q * b) : !f || w !== t.day && w !== t.week ? f && w === t.hour && 1 < b ? d.makeTime(c, m, n, e + q * b) : g + w * b : d.makeTime(c, m, n + q * b * (w === t.day ? 1 : 7)), q++;
                    k.push(g);
        ...
        class B {
            ...
            update() {
                ...
                if (this[v + "Setter"]) this[v + "Setter"]();
                    ...
                    a.element && a.attr(v, l, null, !0) : a.style[v] = l + this.unit;
                p && p.call(a, l, this)
            }
            run(a, v, l) {
                const p = this,
                ...
                a !== v || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date, this.start = a, this.end = v, this.unit = l, this.now = this.start, this.pos = 0, m.elem = this.elem, m.prop = this.prop, m() && 1 === B.timers.push(m) &&
    ...
    M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y) {
        ...
        const t =
            y && u(y.createPolicy) && y.createPolicy("highcharts", {
                createHTML: e => e
            });
        y = t ? t.createHTML("") : "";
        try {
        ...
        class g {
            static filterUserAttributes(e) {
                l(e, (h, m) => {
                    let a = !0; - 1 === g.allowedAttributes.indexOf(m) && (a = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(m) && (a = v(h) && g.allowedReferences.some(d => 0 === h.indexOf(d)));
                    a || (B(33, !1, void 0, {
            ...
            parseMarkup(e) {
                ...
                if (h) e = (new DOMParser).parseFromString(t ? t.createHTML(e) : e, "text/html");
                else {
                    const g = z("div");
                    g.innerHTML = e;
                    e = {
        ...
        (function (a) {
            function y(a, u, v) {
                ...
                for (a = a.map(e => ({
                    ...
                    h = a.length;
                    for (g = !1; h--;) 0 < h && a[h - 1].pos + a[h - 1].size > a[h].pos && (a[h - 1].size += a[h].size, a[h - 1].targets = a[h - 1].targets.concat(a[h].targets), a[h - 1].align = .5, a[h - 1].pos + a[h - 1].size >
    ...
    M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"],
        ...
        class D {
            ...
            getBBox(b, c) {
                ...
                let J;
                let N;
                e(A) && (N = A.toString(), -1 === N.indexOf("<") && (N = N.replace(/[0-9]/g,
                    "0")), N += ["", q.rootFontSize, K, c, this.textWidth, d, a && a.textOverflow, a && a.fontWeight].join());
                N && !b && (J = r[N]);
                if (!J) {
                    if (m || q.forExport) {
                        try {
...
""},${Math.round(b)}`] || b);
            ...
            shadow(b) {
                ...
                const {
                    renderer: f
                } = this, d = G(90 === (null === (c = this.parentGroup) || void 0 === c ? void 0 : c.rotation) ? {
                    offsetX: -1,
                    offsetY: -1
                } : {}, r(b) ? b : {});
            ...
            zIndexSetter(b, f) {
                ...
                if (a) {
                    ...
                    f = n.childNodes;
                    for (r = f.length - 1; 0 <= r &&
                        !A; r--)
                        if (k = f[r], a = k.getAttribute("data-z-index"), g = !e(a), k !== q)
                            if (0 > b && g && !d && !r) n.insertBefore(q, f[r]), A = !0;
                            else if (c(a) <= b || g && (!e(b) || 0 <= b)) n.insertBefore(q, f[r + 1]), A = !0;
        ...
        D.prototype.matrixSetter = D.prototype.rotationOriginXSetter = D.prototype.rotationOriginYSetter = D.prototype.rotationSetter =
            D.prototype.scaleXSetter = D.prototype.scaleYSetter = D.prototype.translateXSetter = D.prototype.translateYSetter = D.prototype.verticalAlignSetter = function (b, c) {
                this[c] = b;
                this.doTransform = !0
            };
        "";
    ...
    M(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, y) {
        ...
        class u extends a {
            ...
            anchorXSetter(a, l) {
                this.anchorX = a;
                this.boxAttr(l, Math.round(a) - this.getCrispAdjust() -
                    this.xSetting)
            }
            anchorYSetter(a, l) {
                this.anchorY = a;
            ...
            updateBoxSize() {
                ...
                this.heightSetting && (this.baselineOffset += (this.heightSetting - m.h) /
                    2);
    ...
    M(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
        function x(a, u, v, l, p) {
            ...
            if (p) {
                ...
                C(g) && (r = ["A", g, g, 0, k, C(p.clockwise) ? 1 - p.clockwise :
                    0, a + g * w, u + g * E
                ], r.params = {
                    start: l,
                    end: m,
        ...
        return {
            ...
            callout: function (a, u, v, l, p) {
                ...
                if (!z(h)) return g;
                a + h >= v ? p > u + m && p < u + l - m ? g.splice(3, 1, ["L", a + v, p - 6], ["L", a + v + 6, p], ["L", a + v, p + 6], ["L", a + v, u + l - t]) : g.splice(3, 1, ["L", a + v, l / 2], ["L", h, p], ["L", a + v, l / 2], ["L", a + v, u + l - t]) : 0 >= a + h ? p > u + m && p < u + l - m ? g.splice(7, 1, ["L", a, p + 6], ["L", a - 6, p], ["L", a, p - 6], ["L", a, u + t]) : g.splice(7, 1, ["L", a, l / 2], ["L", h, p], ["L", a, l / 2], ["L", a, u + t]) : p && p > l && h > a + m && h < a + v - m ? g.splice(5, 1, ["L",
                    h + 6, u + l
                ], ["L", h, u + l + 6], ["L", h - 6, u + l], ["L", a + t, u + l]) : p && 0 > p && h > a + m && h < a + v - m && g.splice(1, 1, ["L", h - 6, u], ["L", h, u - 6], ["L", h + 6, u], ["L", v - t, u]);
                return g
            },
        ...
        class t {
            ...
            buildSVG() {
                ...
                if (d !== m.textCache) {
                    ...
                    w || this.ellipsis || this.width || m.textPath || -1 !== e.indexOf(" ") && (!this.noWrap || t.test(e)) ?
                        "" !== e && (g && g.appendChild(h), e = new a(e), this.modifyTree(e.nodes), e.addToDOM(h), this.modifyDOM(), this.ellipsis && -1 !== (h.textContent || "").indexOf("…") && m.attr("title", this.unescapeEntities(m.textStr || "", ["&lt;", "&gt;"])), g && g.removeChild(h)) : h.appendChild(x.createTextNode(this.unescapeEntities(e)));
            ...
            modifyDOM() {
                ...
                if (e) {
                    var w = (g, d) => {
                            ...
                            let b = 0,
                                f = a.actualWidth;
                            if (this.ellipsis) k && this.truncate(g, k, void 0, 0, Math.max(0, e - .8 * m), (b, f) => b.substring(0, f) + "…");
                            else if (q) {
                                k = [];
                ...
                const h =
                    (g, e) => {
                        const {
                            ...
                            style: p = {},
                            tagName: d
                        } = g, k = this.renderer.styledMode;
                        if ("b" === d || "strong" === d) k ? m["class"] = "highcharts-strong" : p.fontWeight = "bold";
                        else if ("i" === d || "em" === d) k ? m["class"] = "highcharts-emphasized" : p.fontStyle = "italic";
            ...
            truncate(a, h, g, e, l, p) {
                ...
                if (e + f > l) {
                    for (; r <=
                        q;) w = Math.ceil((r + q) / 2), g && (b = p(g, w)), f = c(w, b && b.length - 1), r === q ? r = q + 1 : f > l ? q = w - 1 : r = w;
    ...
    M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"],
        ...
        class V {
            ...
            init(b, c, f, a, k, n, J) {
                ...
                b.appendChild(e);
                d(b, "dir", "ltr"); - 1 === b.innerHTML.indexOf("xmlns") && d(e, "xmlns", this.SVG_NS);
                this.box = e;
                this.boxWrapper = A;
                this.alignedObjects = [];
            ...
            button(c,
                ...
                A.setState = function (b) {
                    1 !== b && (A.state = N = b);
                    A.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + ["normal", "hover", "pressed",
                        "disabled"
                    ][b || 0]);
            ...
            rect(c, f, a, k, e, q) {
                ...
                this.styledMode || ("undefined" !== typeof q && (c["stroke-width"] = q, b(c, A.crisp(c))),
                    c.fill = "none");
            ...
            symbol(c, f, a, n, e, g) {
                ...
                let D, G, P, t;
                if (l) "number" ===
                    typeof f && (G = l.call(this.symbols, Math.round(f || 0), Math.round(a || 0), n || 0, e || 0, g)), D = this.path(G), A.styledMode || D.attr("fill", "none"), b(D, {
                        symbolName: m || void 0,
                        x: f,
                        y: a,
                        width: n,
    ...
    M(a, "Core/Axis/Tick.js", [a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        class h {
            ...
            addLabel() {
                ...
                e.dateTime && (G ? (D = p.time.resolveDTLFormat(h.dateTimeLabelFormats[!h.grid &&
                    G.higherRanks[r] || G.unitName]), P = D.main) : l(t) && (P = e.dateTime.getXDateFormat(t, h.dateTimeLabelFormats || {})));
                g.isFirst = b;
                g.isLast = f;
                const x = {
                    axis: e,
            ...
            createLabel(a, e, h) {
                const g = this.axis,
                    m = g.chart;
                if (a = H(e) && h.enabled ? m.renderer.text(e, a.x, a.y, h.useHTML).add(g.labelGroup) :
                    null) m.styledMode || a.css(p(h.style)), a.textPxLength = a.getBBox().width;
                return a
            }
            destroy() {
                B(this, this.axis)
            ...
            getLabelPosition(a,
                ...
                f && (l = k /
                    (r || 1) % f, q.opposite && (l = f - l - 1), e += q.labelOffset / f * l);
                D.x = a;
                D.y = Math.round(e);
            ...
            handleOverflow(a) {
                ...
                d = m(e.labelRight, Math.max(e.isRadial ?
                    0 : e.pos + e.len, l - d[1]));
                const r = this.label,
                    q = this.rotation,
                    p = {
                ...
                let n = f,
                    t = 1,
                    D;
                if (q || "justify" !== g.overflow) 0 > q && h - p * b < k ? D = Math.round(h / Math.cos(q * x) - k) : 0 < q && h + p * b > d && (D = Math.round((l - h) / Math.cos(q * x)));
                else if (l = h + (1 - p) * b, h - p * b < k ? n = a.x + n * (1 - p) - k : l > d && (n = d - a.x + n * p, t = -1), n = Math.min(f, n), n < f && "center" === e.labelAlign && (a.x += t * (f - n - p * (f - Math.min(b, n)))), b > n || e.autoRotation && (r.styles || {}).width) D = n;
                D &&
    ...
    M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z, H, B) {
        ...
        a, {
            ...
            splat: T,
            syncTimeout: Z
        } = B, V = (b, c) => n(c, void 0, void 0, D(b.options.allowDecimals, .5 > c || void 0 !== b.tickAmount), !!b.tickAmount);
        class Y {
            constructor(b, c, f) {
            ...
            init(c, f, a = this.coll) {
                ...
                this.side = D(f.side, this.side, this.horiz ? this.opposite ? 0 : 2 :
                    this.opposite ? 1 : 3);
                this.setOptions(f);
                a = this.options;
                const A = a.labels,
                ...
                this.crosshair = !0 === f ? {} : f; - 1 === c.axes.indexOf(this) && (d ? c.axes.splice(c.xAxis.length, 0, this) : c.axes.push(this), q(this, c[this.coll]));
                c.orderItems(this.coll);
                this.series = this.series || [];
                c.inverted && !this.isZAxis && d && "undefined" === typeof this.reversed &&
                    (this.reversed = !0);
            ...
            defaultLabelFormatter(c) {
                ...
                if (f.categories) g = `${this.value}`;
                    ...
                    for (; q-- && "undefined" === typeof g;) f = Math.pow(n, q + 1), e >= f && 0 === 10 * a % f && null !== A[q] && 0 !== a && (g = c(a / f, -1) + A[q]);
                    ...
                    c.series.forEach(function (d) {
                        if (d.visible || !f.options.chart.ignoreHiddenSeries) {
                            ...
                            if (c.isXAxis)(k = d.xData) && k.length && (k = c.logarithmic ? k.filter(b => 0 < b) : k, a = d.getXExtremes(k), n = a.min, A = a.max, b(n) || n instanceof Date || (k = k.filter(b), a = d.getXExtremes(k), n = a.min, A = a.max), k.length && (c.dataMin = Math.min(D(c.dataMin, n), n), c.dataMax = Math.max(D(c.dataMax,
                                A), A)));
                            else if (d = d.applyExtremes(), b(d.dataMin) && (n = d.dataMin, c.dataMin = Math.min(D(c.dataMin, n), n)), b(d.dataMax) && (A = d.dataMax, c.dataMax = Math.max(D(c.dataMax, A), A)), e(f) && (c.threshold = f), !k.softThreshold || c.positiveValuesOnly) c.softThreshold = !1
                        }
                    })
                });
            ...
            getPlotLinePath(c) {
                ...
                k(this, "getPlotLinePath", c, function (c) {
                    ...
                    b(p) ? a.horiz ? (w = e, Q = r - a.bottom, P = R = f(P, n, n + a.width)) : (P = n, R = m - a.right, w = Q = f(w, e, e + a.height)) : (K = !0,
                        t = !1);
                    c.path = K && !t ? null : d.renderer.crispLine([
                        ["M", P, w],
                        ["L", R, Q]
                    ], g || 1)
                });
            ...
            getMinorTickPositions() {
                ...
                if (k && k / f < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) n = n.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(f), d, a, b.startOfWeek));
                    else
                        for (b = d + (c[0] - d) % f; b <= a && b !== n[0]; b += f) n.push(b)
                }
            ...
            adjustForMinRange() {
                ...
                if (this.isXAxis && "undefined" === typeof this.minRange && !c)
                    if (e(b.min) || e(b.max) || e(b.floor) || e(b.ceiling)) this.minRange = null;
                    else {
                    ...
                    } a - f < this.minRange && (n = this.dataMax - this.dataMin >= this.minRange, k = this.minRange, a = (k - a + f) /
                    2, d = [f - a, D(b.min, f - a)], n && (d[2] = c ? c.log2lin(this.dataMin) : this.dataMin), f = t(d), a = [f + k, D(b.max, f + k)], n && (a[2] = c ? c.log2lin(this.dataMax) : this.dataMax), a = m(a), a - f < k && (d[0] = a - k, d[1] = D(b.min, a - k), f = t(d)));
                this.min = f;
                this.max = a
            }
            getClosest() {
                ...
                if (this.categories) c = 1;
                    ...
                    this.series.forEach(function (b) {
                        ...
                        1 === (null === (a = b.xData) || void 0 === a ? void 0 : a.length) ? f.push(b.xData[0]) : !b.noSharedTooltip && e(d) &&
            ...
            nameToX(b) {
                ...
                e(a) || (a = this.options.uniqueNames && f ? c ? f.indexOf(b.name) : D(f.keys[b.name], -1) : b.series.autoIncrement()); - 1 === a ? !c && f && (d = f.length) : d = a;
            ...
            setAxisTranslation() {
                ...
                }), a = b.ordinal && b.ordinal.slope && q ? b.ordinal.slope / q : 1, b.minPointOffset = g *= a, b.pointRangePadding = h *= a, b.pointRange = Math.min(e, b.single && d ? 1 :
                    c), n && q && (b.closestPointRange = q);
            ...
            setTickInterval(c) {
                ...
                a && (this.positiveValuesOnly && !c && 0 >= Math.min(this.min, D(this.dataMin,
                    this.min)) && F(10, 1, f), this.min = g(a.log2lin(this.min), 16), this.max = g(a.log2lin(this.max), 16));
                ...
                !(A || this.axisPointRange || this.stacking &&
                    this.stacking.usePercentage || q) && e(this.min) && e(this.max) && (f = this.max - this.min) && (!e(w) && l && (this.min -= f * l), !e(K) && m && (this.max += f * m));
                ...
                r && e(this.dataMin) && (t = t || 0, !e(w) && this.min < t && this.dataMin >= t ? this.min = this.options.minRange ? Math.min(t, this.max - this.minRange) : t : !e(K) && this.max > t && this.dataMax <= t && (this.max = this.options.minRange ? Math.max(t, this.min + this.minRange) :
                    t));
                ...
                !p && this.tickInterval < c && (this.tickInterval =
                    c);
            ...
            setTickPositions() {
                ...
                this.minorTickInterval =
                    "auto" === d && this.tickInterval ? this.tickInterval / c.minorTicksPerMajor : d;
                ...
                if (f) q = f.slice();
                    ...
                    if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)))
                        if (this.dateTime) q = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, c.units), this.min, this.max, c.startOfWeek, this.ordinal && this.ordinal.positions,
                            this.closestPointRange, !0);
                        else if (this.logarithmic) q = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);
                    else
                        for (d = c = this.tickInterval; d <= 2 * c;)
                            if (q = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && q.length > this.tickAmount) this.tickInterval = V(this, d *= 1.1);
                            else break;
                    else q = [this.min, this.max], F(19, !1, this.chart);
                    q.length > this.len && (q = [q[0], q[q.length - 1]], q[0] === q[1] && (q.length = 1));
                    a && (this.tickPositions = q, (h = a.apply(this, [this.min, this.max])) &&
                        (q = h))
                }
            ...
            trimTicks(b, c, f) {
                ...
                if (!this.isLinked) {
                    ...
                    if (f) this.max = d;
                        ...
                        for (; this.max + n < b[b.length - 1];) b.pop();
            ...
            getThresholdAlignment(c) {
                ...
                if (b(this.threshold)) return c = h((this.threshold - (this.dataMin ||
                ...
                if (c.hasData() && b(d) && b(a)) {
                    ...
                    if (b(p) && b(c.threshold)) {
                        for (; n[p] !== m || n.length !== q || n[0] > d || n[n.length - 1] < a;) {
                            n.length = 0;
                            for (n.push(c.threshold); n.length < q;) void 0 === n[p] || n[p] > c.threshold ? n.unshift(g(n[0] - l)) : n.push(g(n[n.length -
                                1] + l));
            ...
            setScale() {
                ...
                f || b || c || this.isLinked || this.forceRedraw || this.userMin !== (this.old &&
                    this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (this.stacking && (this.stacking.resetStacks(), this.stacking.buildStacks()), this.forceRedraw = !1, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), this.isDirty || (this.isDirty = f || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max))) : this.stacking && this.stacking.cleanStacks();
            ...
            zoom(b, c) {
                ...
                k(this, "zoom", b, function (b) {
                    let c = b.newMin,
                        n = b.newMax;
                    if (c !== f.min || n !== f.max) f.allowZoomOutside || (e(a) && (c < q && (c = q), c > g && (c = g)), e(d) && (n < q && (n = q), n > g && (n = g))), f.displayBtn =
                        "undefined" !== typeof c || "undefined" !== typeof n, f.setExtremes(c, n, !1, void 0, {
                            trigger: "zoom"
                        });
                    b.zoomed = !0
                });
            ...
            setAxisSize() {
                ...
                c = this.left = Math.round(K(D(c.left, b.plotLeft + f[3]), b.plotWidth,
                    b.plotLeft));
            ...
            unsquish() {
                ...
                let h = a,
                    r, l = Number.MAX_VALUE,
                    m;
                if (f) {
                    if (c.staggerLines ||
                        (b(n) ? m = [n] : d < c.autoRotationLimit && (m = c.autoRotation)), m) {
                        let b;
                        for (const c of m)
                            if (c === n || c && -90 <= c && 90 >= c) f = q(Math.abs(k / Math.sin(p * c))), b = f + Math.abs(c / 360), b < l && (l = b, r = c, h = f)
                    }
                } else h = q(k);
                this.autoRotation = m;
            ...
            getSlotWidth(c) {
                ...
                if (a && 2 > d.step) return d.rotation ? 0 : (this.staggerLines ||
                    1) * this.len / n;
                if (!a) {
                    c = d.style.width;
            ...
            renderUnsquish() {
                ...
                if (this.autoRotation) D > g && D > r.h ? h.rotation = this.labelRotation : this.labelRotation = 0;
                else if (q && (l = g, !m))
                ...
                this.tickRotCorr = c.rotCorr(r.b,
            ...
            getOffset() {
                ...
                if (!c.axisGroup) {
                    ...
                    c.labelGroup = b("axis-labels", "-labels",
                        w.zIndex)
                }
                ...
                t && t.text && !1 !== t.enabled && (c.addTitle(ja), ja && !K && !1 !== t.reserveSpace && (c.titleOffset =
                    u = c.axisTitle.getBBox()[a ? "height" : "width"], x = t.offset, E = e(x) ? 0 : D(t.margin, a ? 5 : 10)));
                c.renderLine();
                ...
                "colorAxis" !== h && (w = this.tickSize("tick"), G[n] = Math.max(G[n], (c.axisTitleMargin ||
                    0) + u + Q * c.offset, E, g && g.length && w ? w[0] + Q * c.offset : 0), G = !c.axisLine || d.offset ? 0 : 2 * Math.floor(c.axisLine.strokeWidth() / 2), R[l] = Math.max(R[l], G));
            ...
            getLinePath(b) {
                ...
                return c.renderer.crispLine([
                    ...
                    ["L", d ? c.chartWidth - this.right : n, d ? a : c.chartHeight - this.bottom]
                ], b)
            }
            renderLine() {
                this.axisLine ||
                    (this.axisLine = this.chart.renderer.path().addClass("highcharts-axis-line").add(this.axisGroup), this.chart.styledMode || this.axisLine.attr({
            ...
            renderTick(b, c, f) {
                const a = this.ticks;
                if (!this.isLinked || b >= this.min && b <= this.max || this.grid && this.grid.isColumn) a[b] || (a[b] = new H(this,
            ...
            render() {
                ...
                if (c.hasData() || n) {
                    ...
                    m && e.forEach(function (b, d) {
                        ...
                        0 === d % 2 && b < c.max && G <= c.max + (f.polar ?
                            -D : D) && (r[b] || (r[b] = new z.PlotLineOrBand(c)), Q = b + D, r[b].options = {
            ...
            destroy(b) {
                ...
                for (const b in c.plotLinesAndBandsGroups) c.plotLinesAndBandsGroups[b] =
        ...
        (function (y) {
            ...
            class v {
                ...
                getLogTickPositions(a, p, t, m) {
                    ...
                    if (.5 <= a) a = Math.round(a), l = h.getLinearTickPositions(a, p, t);
                    else if (.08 <= a) {
                        e = Math.floor(p);
                        let h, w, d, k, r;
                        for (g = .3 < a ? [1, 2, 4] : .15 <
                            a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < t + 1 && !r; e++)
                            for (w = g.length, h = 0; h < w && !r; h++) d = this.log2lin(this.lin2log(e) * g[h]), d > p && (!m || k <= t) && "undefined" !== typeof k && l.push(k), k > t && (r = !0), k = d
    ...
    M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [a["Core/Utilities.js"]], function (a) {
        ...
        (function (y) {
            ...
            function v(a, e, h = this.options) {
                ...
                let k;
                if (a && g)
                    for (e && (k = a.toString() === g.toString(), h = 0), e = 0; e < a.length; e += 2) {
                        const r = a[e],
                            q = a[e + 1],
                            m = g[e],
                            b = g[e + 1];
            ...
            function p(a) {
                ...
                if (e) {
                    ...
                    [g.plotLines || [], h.plotLines || [],
                        g.plotBands || [], h.plotBands || []
                    ].forEach(function (d) {
        ...
        function (a, y) {
            ...
            class p {
                ...
                renderLabel(a, l, h, g) {
                    ...
                    l =
                        l.yBounds || [l[0][2], l[1][2], h ? l[2][2] : l[0][2]];
                    h = L(g);
                    m = L(l);
                    p.align(a, !1, {
                        x: h,
    ...
    M(a, "Core/Tooltip.js", [a["Core/Templating.js"], a["Core/Globals.js"],
        ...
        class r {
            ...
            defaultFormatter(a) {
                ...
                b.push(a.tooltipFooterHeaderFormatter(k[0],
                    !0));
                return b
            }
            destroy() {
            ...
            getAnchor(a, k) {
                ...
                if (this.followPointer && k) "undefined" ===
                    typeof k.chartX && (k = f.normalize(k)), a = [k.chartX - b, k.chartY - n];
            ...
            getClassName(a, d, b) {
                const f = a.series,
                    c = f.options;
                return [this.options.className, "highcharts-label", b && "highcharts-tooltip-header", d ? "highcharts-tooltip-box" : "highcharts-tooltip", !b && "highcharts-color-" + F(a.colorIndex,
                ...
                if (f.enabled && e.series) {
                    ...
                    if (!1 === r) this.hide();
                        ...
                        if (this.split && this.allowShared) this.renderSplit(r, n);
                            ...
                            if (b.polar || !1 === l.options.clip || n.some(b => c.isDirectTouch || b.series.shouldShowTooltip(d,
                                    g))) k = this.getLabel(), f.style.width && !p || k.css({
            ...
            renderSplit(a, d) {
                    ...
                    if (!1 !== a && "" !== a) {
                        ...
                        var k = D ? f : n.series,
                            ...
                            m || (m = {
                                padding: E.padding,
                                r: E.borderRadius
                            }, G || (m.fill = E.backgroundColor, m["stroke-width"] = null !== (q = E.borderWidth) &&
                                void 0 !== q ? q : 1), m = O.label("", 0, 0, E[b ? "headerShape" : "shape"], void 0, void 0, E.useHTML).addClass(f.getClassName(r, !0, b)).attr(m).add(N));
                            m.isActive = !0;
                            m.attr({
                                text: a
                            });
                ...
                !y && a.some(b => {
                    ...
                    const {
                        x: a,
                        y: f
                    } = b(c.anchorX, c.anchorY, c.point.isHeader,
                        c.boxWidth, !1);
                    return m(c, {
                        target: f,
                        x: a
            ...
            drawTracker() {
                if (this.shouldStickOnContact()) {
                    ...
                    if (d && b) {
                        ...
                        f.y = Math.min(0, b[1]);
                        f.width = 0 > b[0] ?
                            Math.max(Math.abs(b[0]), c.width - b[0]) : Math.max(Math.abs(b[0]), c.width);
    ...
    M(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"],
        ...
        class G {
            ...
            applyOptions(b, a) {
                ...
                "undefined" === typeof this.x && c ? this.x = "undefined" === typeof a ? c.autoIncrement() :
                    a : e(b.x) && c.options.relativeXValue && (this.x = c.autoIncrement(b.x));
                return this
            }
            destroy() {
                if (!this.destroyed) {
            ...
            optionsToObject(b) {
                ...
                if (e(b) || null === b) g[d[0]] = b;
                    ...
                    for (!c && b.length > k && (a = typeof b[0], "string" === a ? g.name = b[0] : "number" === a && (g.x = b[0]), q++); r < k;) c && "undefined" === typeof b[q] || (0 < d[r].indexOf(".") ? G.prototype.setNestedProperty(g, b[q], d[r]) : g[d[r]] = b[q]), q++, r++;
                else "object" === typeof b && (g = b, b.dataLabels &&
                    (a._hasPointLabels = !0), b.marker && (a._hasPointMarkers = !0));
                return g
            }
            pos(b, a = this.plotY) {
                if (!this.destroyed) {
            ...
            resolveColor() {
                ...
                b.options.colorByPoint ? (a || (k = b.options.colors || b.chart.options.colors, c = k[b.colorCounter],
            ...
            update(b, a, c, k) {
                function f() {
                    ...
                    w(b, !0) && (g && g.element && b && b.marker && "undefined" !== typeof b.marker.symbol && (n.graphic = g.destroy()), b && b.dataLabels &&
                        n.dataLabel && (n.dataLabel = n.dataLabel.destroy()), n.connector && (n.connector = n.connector.destroy()));
                    r = n.index;
            ...
            setState(b, f) {
                ...
                if (!(b === this.state && !f || this.selected && "select" !== b || !1 === g.enabled || b && (l || q && !1 === r.enabled) || b && m.states && m.states[b] && !1 === m.states[b].enabled)) {
                    ...
                    g && g.size && E && "hidden" !== u && !this.isCluster ? (G || (c.halo = G = w.renderer.path().add(E.parentGroup)), G.show()[f ? "animate" : "attr"]({
                        ...
                        }, a.filterUserAttributes(g.attributes || {})))) : G && G.point && G.point.haloPath &&
                        G.animate({
    ...
    M(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        class F {
            ...
            drop(a) {
                ...
                if (this.selectionMarker) {
                    const {
                        ...
                        width: f,
                        height: c
                    } = this.getSelectionBox(this.selectionMarker), n = {
                        originalEvent: a,
                        xAxis: [],
                        yAxis: [],
                        x: k,
                    ...
                    if ((b = h(a, !0) && a.series) && !(b = !h(d, !0))) {
                        {
                            ...
                            const f = d.dist - a.dist,
                                c = (a.series.group &&
                                    a.series.group.zIndex) - (d.series.group && d.series.group.zIndex);
            ...
            onContainerMouseDown(a) {
                ...
                a = this.normalize(a);
                if (y.isFirefox &&
                    0 !== a.button) this.onContainerMouseMove(a);
            ...
            pinch(a) {
                const d = this,
                    ...
                    n = {},
                    m = 1 === b &&
                    (d.inClass(a.target, "highcharts-tracker") && e.runTrackerClick || d.runChartClick),
                    p = {};
            ...
            reset(a, e) {
                ...
                if (a) f && c &&
                    E(c).length && (f.refresh(c), f.shared && b ? b.forEach(function (b) {
            ...
            class G {
                ...
                colorizeItem(b, a) {
                    ...
                    if (!this.chart.styledMode) {
                        const {
                            itemHiddenStyle: c
                        } = this, g = c.color, k = a ? b.color || g : g, n = b.options && b.options.marker;
                        let h = {
                            fill: k
                        };
                        ...
                        e && (n && e.isMarker && (h = b.pointAttribs(), a || (h.stroke =
                            h.fill = g)), e.attr(h))
                    }
                ...
                proximatePositions() {
                    ...
                    this.allItems.forEach(function (d) {
                        ...
                        var g = c;
                        let k;
                        d.yAxis && (d.xAxis.options.reversed && (g = !g), d.points && (f =
                            e(g ? d.points : d.points.slice(0).reverse(), function (b) {
                                return E(b.plotY)
                ...
                render() {
                    ...
                    var m = b.spacingBox.width - 2 * d - c.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (m /= 2);
                    ...
                    this.renderTitle();
                    r(e, (b, a) => (b.options && b.options.legendIndex ||
                        0) - (a.options && a.options.legendIndex || 0));
                ...
                align(b = this.chart.spacingBox) {
                    ...
                    /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0] ?
                        d += a.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < a.titleOffset[2] && (d -= a.titleOffset[2]);
                    d !== b.y && (b = F(b, {
                        y: d
                    }));
                ...
                handleOverflow(b) {
                    ...
                    b && 0 < k && b > k && !1 !== q.enabled ? (this.clipHeight = x = Math.max(k - 20 - this.titleHeight - l, 0), this.currentPage = d(this.currentPage, 1), this.fullHeight = b, w.forEach((b, a) => {
                            ...
                            b !== J && (J = b)
                        }), E || (E = a.clipRect = e.clipRect(0, l - 2, 9999, 0), a.contentGroup.clip(E)),
                        v(x), O || (this.nav = O = e.g().attr({
                            zIndex: 1
                ...
                scroll(b, a) {
                    ...
                    0 < m && ("undefined" !== typeof a && B(a, c), this.nav.attr({
                        ...
                        b = x(d(a, c.renderer.globalAnimation, !0)), q(() => {
                            w(this, "afterScroll", {
                                currentPage: m
                            })
                        }, b.duration))
    ...
    M(a, "Core/Legend/LegendSymbol.js", [a["Core/Utilities.js"]], function (a) {
        ...
        (function (a) {
            a.lineMarker = function (a, B) {
                ...
                h["stroke-linecap"] && (e = Math.min(B.line.strokeWidth(),
                    v) / 2);
                v && B.line.attr({
                    d: [
                        ["M", e, a],
            ...
            a.rectangle = function (a, x) {
                ...
                x.symbol = this.chart.renderer.rect(v ? (a.symbolWidth - u) / 2 : 0, a.baseline - u + 1, v ? u : a.symbolWidth, u, L(a.options.symbolRadius,
                    u / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(x.group)
            }
        })(C || (C = {}));
    ...
    M(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesDefaults.js"],
        ...
        class aa {
            ...
            autoIncrement(b) {
                ...
                d && T(b) && (g *= b);
                c && (a = new f.Date(e), "day" === c ? f.set("Date", a, f.get("Date",
                    a) + g) : "month" === c ? f.set("Month", a, f.get("Month", a) + g) : "year" === c && f.set("FullYear", a, f.get("FullYear", a) + g), g = a.getTime() - e);
                if (d && T(b)) return e + g;
                this.xIncrement = e + g;
                return e
            }
            ...
            setOptions(b) {
                ...
                this.stickyTracking = A(g.stickyTracking, q.stickyTracking, l.stickyTracking, this.tooltipOptions.shared &&
                    !this.noSharedTooltip ? !0 : f.stickyTracking);
            ...
            findPointIndex(b, a) {
                ...
                if (d) g = this.chart.get(d), g instanceof z && (k = g);
                    ...
                    if (k = a => !a.touched && a.index === b.index, g && g.matchByName ? k = a => !a.touched && a.name === b.name :
                        this.options.relativeXValue && (k = a => !a.touched && a.options.x === b.x), k = c(e, k), !k) return;
                k && (n = k && k.index, "undefined" !== typeof n && (h = !0));
                "undefined" === typeof n && T(f) && (n = this.xData.indexOf(f, a)); - 1 !== n && "undefined" !== typeof n && this.cropped && (n = n >= this.cropStart ? n - this.cropStart : n);
            ...
            updateData(b, a) {
                ...
                else !k || d && d.enabled ? m = !1 : (b.forEach(function (b, a) {
                ...
                if (!v) {
                    ...
                    if (p && N > p)
                        if (x = g.getFirstValidPoint(a), T(x))
                            for (d = 0; d < N; d++) r[d] = this.autoIncrement(),
                                t[d] = a[d];
                        else if (X(x))
                        if (w)
                            if (x.length === w)
                                for (d = 0; d < N; d++) r[d] = this.autoIncrement(), t[d] = a[d];
                            else
                                for (d = 0; d < N; d++) f = a[d], r[d] = f[0], t[d] = f.slice(1, w + 1);
                    else if (J && (u = J.indexOf("x"), O = J.indexOf("y"), u = 0 <= u ? u : 0, O = 0 <= O ? O : 1), 1 === x.length && (O = 0), u === O)
                        for (d = 0; d < N; d++) r[d] = this.autoIncrement(), t[d] = a[d][O];
                    else
                        for (d = 0; d < N; d++) f = a[d], r[d] = f[u], t[d] = f[O];
                    else b(12, !1, l);
                    else
                        for (d = 0; d < N; d++) f = {
                            series: g
            ...
            generatePoints() {
                ...
                for (p = 0; p < g; p++) w = k + p, h ? (r = (new e).init(this, [c[p]].concat(ia(d[p]))), r.dataGroup = this.groupMap[b + p], r.dataGroup.options && (r.options = r.dataGroup.options,
                    f(r, r.dataGroup.options), delete r.dataLabels)) : (r = t[w]) || "undefined" === typeof a[w] || (t[w] = r = (new e).init(this, a[w], c[p])), r && (r.index = h ? b + p : w, m[p] = r);
                this.options.keys = l;
                if (t && (g !== (q = t.length) || h))
                    for (p = 0; p < q; p++) p !== k || h || (p += g), t[p] && (t[p].destroyElements(), t[p].plotX = void 0);
                this.data = t;
                this.points = m;
            ...
            translate() {
                ...
                for (w = 0; w < m; w++) {
                    ...
                    c && this.visible && E && E[m] && (x = this.getStackIndicator(x, m, this.index), !n.isNull && x.key && (J = E[m], Q = J.points[x.key]), J && X(Q) && (O = Q[0], R = Q[1], O === a && x.key === E[m].base && (O = A(T(t) ? t : h.min)), h.positiveValuesOnly && r(O) && 0 >= O && (O = void 0), n.total = n.stackTotal =
                        A(J.total), n.percentage = r(n.y) && J.total ? n.y / J.total * 100 : void 0, n.stackY = R, this.irregularWidths || J.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis)));
            ...
            setClip() {
                const {
                    ...
                    group: a,
                    markerGroup: c
                } = this, d = b.sharedClips, f = b.renderer, e = this.getClipBox(), g = this.getSharedClipKey();
                let k = d[g];
            ...
            animate(b) {
                ...
                }), a.sharedClips[g + "m"] = n), c.clip(k), d && d.clip(n);
                else if (k && !k.hasClass("highcharts-animating")) {
                    g = this.getClipBox();
                    const b = e.step;
                    d && d.element.childNodes.length && (e.step =
                        function (a, c) {
                ...
                if (!1 !== e.enabled || this._hasPointMarkers)
                    for (h = 0; h < b.length; h++) {
                        ...
                        if ((n && "undefined" === typeof t.enabled || t.enabled) && !l.isNull && !1 !== l.visible) {
                            ...
                            if (m)
                                if (t = this.pointAttribs(l, c || !l.selected ? void 0 : "select"), c) d && m.css({
                                    fill: t.fill
                                });
                                else m[q](t);
            ...
            getPlotBox(b) {
                ...
                const d = this.chart;
                b = d.inverted &&
                    !d.polar && a && !1 !== this.invertible && "series" === b;
            ...
            render() {
                ...
                g || (k && d.defer && (k += d.defer), b.animationTimeout =
                    ba(function () {
                        b.afterAnimate()
                    }, k || 0));
                b.isDirty = !1;
            ...
            searchKDTree(b, a, c) {
                function d(b, a, c, n) {
                    ...
                    var p = r(b[g]) && r(h[g]) ? Math.pow(b[g] -
                        h[g], 2) : null;
                    p = (q || 0) + (p || 0);
                ...
                if (this.kdTree) return d(b, this.kdTree,
                    a, a)
            }
            ...
            update(a, c) {
                ...
                const p = {};
                let r, t = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"],
                    v = a.type || g.type || e.options.chart.type;
                const u = !(this.hasDerivedData || v && v !== this.type || "undefined" !== typeof a.pointStart || "undefined" !== typeof a.pointInterval || "undefined" !== typeof a.relativeXValue || a.joinBy || a.mapData ||
                    d.hasOptionChanged("dataGrouping") || d.hasOptionChanged("pointStart") || d.hasOptionChanged("pointInterval") || d.hasOptionChanged("pointIntervalUnit") || d.hasOptionChanged("keys"));
                v = v || k;
                ...
                if (w[v]) {
                    if (h = v !== d.type, d.remove(!1, !1, !1, !0), h)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(d,
                            w[v].prototype);
                        else {
            ...
            setState(b, a) {
                ...
                if (c.state !== b && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (a) {
                    ...
                    b && (h = g[b].lineWidth || h + (g[b].lineWidthPlus ||
                        0), l = A(g[b].opacity, l));
            ...
            setVisible(b, a) {
                const c = this,
                    ...
                    g = (c.visible = b = c.options.visible =
                        c.userOptions.visible = "undefined" === typeof b ? !e : b) ? "show" : "hide";
        ...
        class ea {
            ...
            setZoomOptions() {
                ...
                this.zooming = Object.assign(Object.assign({}, a), {
                    ...
                    singleTouch: S(b.zoomBySingleTouch, a.singleTouch,
                        !1),
            ...
            orderItems(b, a = 0) {
                ...
                if (c)
                    for (let f = a, e = c.length; f < e; ++f)
                        if (a = c[f]) a.index = f, a instanceof B && (a.name = a.getName()), a.options.isInternal || (d[f] = a.options, b[f] = a.userOptions)
            }
            isInsidePlot(b, a, c = {}) {
                const {
                    inverted: d,
                ...
                if (!c.ignoreX) {
                    ...
                    (h = !d && c.axis && !c.axis.isXAxis && c.axis || l && (d ? l.xAxis : l.yAxis) || {
                        pos: g,
                        len: Infinity
            ...
            redraw(b) {
                ...
                for (b = c.length; b--;)
                    ...
                    for (b = c.length; b--;) r = c[b], r.options.stacking && (r.isDirty = !0);
            ...
            temporaryDisplay(b) {
                let a =
                    this.renderTo;
                if (b)
                    for (; a && a.style;) a.hcOrigStyle && (P(a, a.hcOrigStyle), delete a.hcOrigStyle), a.hcOrigDetached && (k.body.removeChild(a), a.hcOrigDetached = !1), a = a.parentNode;
                else
                    for (; a && a.style;) {
                        ...
                        if ("none" === M(a, "display", !1) || a.hcOricDetached) a.hcOrigStyle = {
                            ...
                            display: "block",
                            overflow: "hidden"
                        }, a !== this.renderTo && (b.height = 0), P(a, b), a.offsetWidth || a.style.setProperty("display",
                            "block", "important");
                        a = a.parentNode;
                        if (a === k.body) break
                    }
            ...
            getContainer() {
                ...
                this.renderer = new(a.renderer || !q ? H.getRendererType(a.renderer) : v)(f, l, m, void 0, a.forExport,
            ...
            getMargins(b) {
                ...
                d[2] && !D(c[2]) && (this.marginBottom = Math.max(this.marginBottom,
                    d[2] + a[2]));
            ...
            setReflow() {
                ...
                "function" === typeof ResizeObserver ? (new ResizeObserver(a)).observe(b.renderTo) : (a = f(G, "resize", a), f(this, "destroy",
                    a))
            }
            setSize(b, a, c) {
                const d = this,
            ...
            propFromSeries() {
                ...
                ["inverted", "angular", "polar"].forEach(function (k) {
                    ...
                    for (f =
                        d && d.length; !g && f--;)(e = b[d[f].type]) && e.prototype[k] && (g = !0);
                    a[k] = g
                })
            }
            linkSeries(b) {
            ...
            addCredits(b) {
                ...
                c.enabled &&
                    !this.credits && (this.credits = this.renderer.text(c.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function () {
            ...
            destroy() {
                ...
                let g;
                A(b, "destroy");
                b.renderer.forExport ? T(d, b) : d[b.index] =
                    void 0;
                z.chartCount--;
            ...
            update(b, a, c, d) {
                ...
                O(b, function (a, c) {
                    ...
                    else "colors" !== c && -1 === f.collectionsWithUpdate.indexOf(c) && N(!0, f.options[c], b[c]);
                    "chart" !==
                ...
                A(this, "pan", {
                    ...
                    a.forEach(function (a) {
                        if (a.options.panningEnabled &&
                            ...
                            a.panningState = t;
                            a.isOrdinal || (n = l - h, 0 < n && (q += n, h = l), n = q - p, 0 < n && (q = p, h -= n), a.series.length && h !== m.min &&
                                q !== m.max && h >= l && q <= p && (a.setExtremes(h, q, !1, !1, {
                                    trigger: "pan"
        ...
        function (a, y, I, L, C, z) {
            ...
            B(I, "afterSetChartSize", function (a) {
                ...
                if (!this.renderer.forExport) {
                    if (h) {
                        ...
                        (this.scrollablePixelsY = h = Math.max(0, m - this.chartHeight), v(h) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = l(this.plotBox), this.plotBox.height = this.plotHeight += h, this.inverted ? this.clipBox.width += h : this.clipBox.height += h, g = {
                            2: {
                                name: "bottom",
                                value: h
                            }
            ...
            I.prototype.moveFixedElements = function () {
                let a = this.container,
                    ...
                    g;
                this.scrollablePixelsX && !this.inverted ? g = ".highcharts-yaxis" : this.scrollablePixelsX && this.inverted ? g = ".highcharts-xaxis" : this.scrollablePixelsY &&
                    !this.inverted ? g = ".highcharts-xaxis" : this.scrollablePixelsY && this.inverted && (g = ".highcharts-yaxis");
            ...
            I.prototype.applyFixed = function () {
                ...
                l = this.plotTop + this.plotHeight +
                    g[2] + 1;
        ...
        function t(b) {
            ...
            if (f && (!0 === this.visible || !1 === a.options.chart.ignoreHiddenSeries)) {
                ...
                for (G = 0; G < l; G++) {
                    ...
                    "percent" === f ? (E = E ? b : t, v &&
                        u[E] && u[E][F] ? (E = u[E][F], z.total = E.total = Math.max(E.total, z.total) + Math.abs(B) || 0) : z.total = e(z.total + (Math.abs(B) || 0))) : "group" === f ? (d(B) && (B = B[0]), null !== B && (z.total = (z.total || 0) + 1)) : z.total = e(z.total + (B || 0));
            ...
            class z extends a {
                ...
                getGraphPath(a, B, u) {
                    ...
                    a.forEach(function (e, g) {
                        ...
                        k && !x(B) && 0 < g ? m = !l.connectNulls : k && !B ? m = !0 : (0 === g || m ? g = [
                                ["M", e.plotX, e.plotY]
                            ] : v.getPointSpline ? g = [v.getPointSpline(a, e, g)] : h ? (g = 1 === h ? [
                                ["L", d.plotX, F]
                            ] : 2 === h ? [
                                ...
                                ["L", w, F]
                            ], t.push(e.x), h && (t.push(e.x), 2 === h && t.push(e.x)),
    ...
    M(a, "Series/AreaSpline/AreaSplineSeries.js", [a["Series/Spline/SplineSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        y.registerSeriesType("areaspline",
            B);
        "";
        return B
    });
    ...
    M(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"],
        ...
        class d extends C {
            ...
            getColumnMetrics() {
                ...
                const l =
                    Math.min(Math.abs(e.transA) * (e.ordinal && e.ordinal.slope || d.pointRange || e.closestPointRange || e.tickInterval || 1), e.len),
                    m = l * d.groupPadding,
                    p = (l - 2 * m) / (h || 1);
                ...
                if (!e.isNull && 1 < h.columnCount) {
                    ...
                    F(this.yAxis.stacking && this.yAxis.stacking.stacks, a => {
                        if ("number" === typeof e.x) {
                            ...
                            d && (a = d.points[this.index], b ? (a && (c = k), d.hasValidPoints && (f ? k++ : k--)) : g(a) && (a = Object.keys(d.points).filter(b => !b.match(",") &&
            ...
            translate() {
                ...
                a.points.forEach(function (k) {
                    ...
                    t(k.options.pointWidth) && (z = G = Math.ceil(k.options.pointWidth),
                        B -= Math.round((z - w) / 2));
            ...
            pointAttribs(a, d) {
                ...
                d && a && (a = w(e.states[d],
                    a.options.states && a.options.states[d] || {}), d = a.brightness, k = a.color || "undefined" !== typeof d && u(k).brighten(a.brightness).get() || k, h = a[b] || h, l = a[f] || l, g = a.dashStyle || g, m = E(a.opacity, m));
                b = {
                    fill: k,
                    stroke: h,
                    "stroke-width": l,
        ...
        (function (a) {
            ...
            function d(a = this.points) {
                ...
                if (u(F) || F.enabled || d._hasPointLabels) y = this.initDataLabels(G), a.forEach(a => {
                    ...
                    A.forEach((b, f) => {
                        var l, m = b.enabled && (!a.isNull || a.dataLabelOnNull) && g(a, b);
    ...
    M(a, "Series/Column/ColumnDataLabel.js", [a["Core/Series/DataLabel.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        (function (y) {
            function u(a, p, t, m, h) {
                ...
                t.verticalAlign =
                    z(t.verticalAlign, g || d ? "middle" : u ? "top" : "bottom");
        ...
        H(l.prototype, {
            connectorShapes: {
                fixedOffset: function (a, l, m) {
                    ...
                    l = l.touchingSliceAt;
                    return [
                        ["M", a.x, a.y], m.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * h.x - l.x, 2 * h.y - l.y, h.x, h.y] : ["L", h.x, h.y],
                        ["L", l.x, l.y]
                    ]
                },
                ...
                crookedLine: function (a, l, m) {
                    ...
                    const [e, p, t] = l.center, u = t / 2, d = l.chart.plotWidth, k = l.chart.plotLeft;
                    l = "left" === a.alignment;
                    const {
                        x: r,
                        y: q
        ...
        class e extends z {
            ...
            drawEmpty() {
                const a = this.startAngleRad,
                    ...
                    g = this.options;
                let d, k;
                0 === this.total && this.center ? (d = this.center[0], k = this.center[1], this.graph || (this.graph = this.chart.renderer.arc(d,
                    k, this.center[1] / 2, 0, a, e).addClass("highcharts-empty-series").add(this.group)), this.graph.attr({
            ...
            drawPoints() {
                ...
                this.points.forEach(function (e) {
                    ...
                    e.graphic || (e.graphic = a[e.shapeType](e.shapeArgs).add(e.series.group),
        ...
        (function (g) {
            function e() {
                ...
                a.visible && (g.enabled || a._hasPointLabels) && (d.forEach(function (a) {
                    ...
                    a.dataLabel && (a.visible ? (y[a.half].push(a), a.dataLabel._pos = null, !l(g.style.width) && !l(a.options.dataLabels && a.options.dataLabels.style &&
                        a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > m && (a.dataLabel.css({
                    ...
                    if (m) {
                        ...
                        if (0 < a.maxLabelDistance) {
                            ...
                            d.forEach(function (a) {
                                0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0,
                                    x - v - a.labelDistance), a.bottom = Math.min(x + v + a.labelDistance, e.plotHeight), p = a.dataLabel.getBBox().height || 21, a.distributeBox = {
                        ...
                        for (W = 0; W < m; W++) {
                            ...
                            t(g.crop, !0) && (L = I.getBBox().width, r = null, N - L < b && 1 === k ? (r = Math.round(L - N + b), z[3] = Math.max(r, z[3])) : N + L > f - b && 0 === k &&
                    ...
                    if (A = t(U.connectorWidth, 1)) {
                        ...
                        if ((I = b.dataLabel) && I._pos && b.visible && 0 < b.labelDistance) {
                            ...
                            if (c = !E) b.connector = E = e.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" +
                                b.colorIndex + (b.className ? " " + b.className : "")).add(a.dataLabelsGroup), e.styledMode || E.attr({
                                "stroke-width": A,
            ...
            function y(a) {
                let d = this.center,
                    ...
                    b = e.minSize || 80,
                    f, c = null !== e.size;
                c || (null !== g[0] ? f = Math.max(d[2] - Math.max(a[1], a[3]), b) : (f = Math.max(d[2] - a[1] - a[3], b), d[0] += (a[3] - a[1]) / 2), null !== g[1] ? f = v(f, b, d[2] - Math.max(a[0], a[2])) : (f = v(f, b, d[2] - a[0] - a[2]), d[1] += (a[0] - a[2]) / 2), f < d[2] ? (d[2] = f, d[3] = Math.min(e.thickness ? Math.max(0, f -
                    2 * e.thickness) : Math.max(0, m(e.innerSize || 0, f)), f), this.translate(d), this.drawDataLabels && this.drawDataLabels()) : c = !0);
                return c
            }
            const z = [],
                d = {
    ...
    M(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function (a, y) {
        function x(a, l) {
            ...
            a && (p = a.newOpacity, a.oldOpacity !== p && (a.alignAttr && a.placed ? (a[p ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                t = !0, a.alignAttr.opacity = p, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, function () {
                    l.styledMode || a.css({
        ...
        a.prototype.hideOverlappingLabels = function (a) {
            ...
            for (h = 0; h < p; h++)
                if (m = a[h]) m.oldOpacity = m.opacity, m.newOpacity = 1, m.absoluteBox = v(m);
            a.sort(function (a, e) {
                return (e.labelrank || 0) - (a.labelrank || 0)
            });
            for (h = 0; h < p; h++)
                for (e = (v = a[h]) && v.absoluteBox, m = h + 1; m < p; ++m) w = (g = a[m]) && g.absoluteBox, !e || !w || v === g || 0 === v.newOpacity || 0 === g.newOpacity || "hidden" === v.visibility || "hidden" === g.visibility || w.x >= e.x + e.width || w.x + w.width <= e.x || w.y >= e.y + e.height || w.y + w.height <= e.y ||
    ...
    M(a, "Extensions/BorderRadius.js", [a["Core/Defaults.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z) {
        ...
        if (-1 === L.symbolCustomAttribs.indexOf("borderRadius")) {
                ...
                for (g = a.length - 1; g--;) {
                    {
                        ...
                        if (k && h && h.params) {
                            ...
                            w = w ? p : -p;
                            u *= Math.cos(p);
                            e ? (n.start = a + w, k[1] = g + u * Math.cos(a), k[2] = l + u * Math.sin(a), m.splice(b + 1, 0, ["A", f, f, 0, 0, 1, g + c * Math.cos(n.start), l + c * Math.sin(n.start)])) : (n.end = d - w, h[6] = g + c * Math.cos(n.end), h[7] =
                                l + c * Math.sin(n.end), m.splice(b + 1, 0, ["A", f, f, 0, 0, 1, g + u * Math.cos(d), l + u * Math.sin(d)]));
            ...
            C.prototype.symbols.roundedRect = function (a, h, l, m, d = {}) {
                ...
                if (n) {
                    const a =
                        Math.sqrt(Math.pow(d, 2) - Math.pow(d - n, 2));
                    f[0] -= a;
                    b[0] += a;
                    w[1] = B[1] = h + d - n
                }
                ...
                e.push(["M", ...f], ["L", ...b], ["A",
                    d, d, 0, 0, 1, ...w
                ], ["L", ...v], ["A", c, c, 0, 0, 1, ...x], ["L", ...y], ["A", c, c, 0, 0, 1, ...z], ["L", ...B], ["A", d, d, 0, 0, 1, ...f], ["Z"]);
                return e
            };
            ...
            B(y, "afterColumnTranslate", function () {
                ...
                if (this.options.borderRadius && (!this.chart.is3d || !this.chart.is3d())) {
                    const {
                        options: e,
                        yAxis: r
                    } = this, q = "percent" === e.stacking;
                    var h = null === (g = null ===
                        (a = x.plotOptions) || void 0 === a ? void 0 : a[this.type]) || void 0 === g ? void 0 : g.borderRadius;
    ...
    ], function (a, y, I, L, C, z, H, B, u, v, l, p, t, m, h, g, e, w, E, F, d, k, r, q, G, b, f, c, n, M, D, K, U, T) {
        a.animate =
            C.animate;
