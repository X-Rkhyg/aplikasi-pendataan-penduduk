...
(function (b) {
    ...
    function x(b, r, q, l) {
        b.hasOwnProperty(r) || (b[r] = l.apply(null, q), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: r,
                module: b[r]
            }
    ...
    x(b, "Accessibility/Utils/HTMLUtilities.js", [b["Core/Globals.js"], b["Core/Utilities.js"]], function (b, r) {
        function q(b) {
            if ("function" === typeof u.MouseEvent) return new u.MouseEvent(b.type, b);
            if (m.createEvent) {
                const n = m.createEvent("MouseEvent");
                if (n.initMouseEvent) return n.initMouseEvent(b.type, b.bubbles, b.cancelable, b.view || u, b.detail, b.screenX, b.screenY, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget), n
            }
            return l(b.type)
        }
        ...
        function l(b, k, g) {
            ...
            return "function" === typeof u.MouseEvent ? new u.MouseEvent(b, {
                ...
                clientX: k.x,
                clientY: k.y
            }) : m.createEvent && (g = m.createEvent("MouseEvent"), g.initMouseEvent) ? (g.initMouseEvent(b, !0, !0, u, "click" === b ? 1 : 0, k.x, k.y, k.x, k.y, !1, !1, !1, !1, 0, null), g) : {
                type: b
            }
        }
        const {
            ...
            css: v
        } = r, z = u.EventTarget && new u.EventTarget || "none";
        return {
            ...
            cloneTouchEvent: function (b) {
                ...
                if ("function" === typeof u.TouchEvent) return n = new u.TouchEvent(b.type, {
                        touches: n(b.touches),
                    ...
                    b.defaultPrevented && n.preventDefault(), n;
                n = q(b);
                n.touches = b.touches;
        ...
        (function (b) {
            function z(a, c) {
                ...
                if (-1 < d) {
                    ...
                    a = "";
                    if (c = l(f[0], c))
                        for (d = isNaN(d) ? c.length : d, d = 0 > d ? c.length + d : Math.min(d, c.length), f = 0; f < d; ++f) a += B + c[f] + e;
                    return a.length ? a : ""
                }
                if (-1 < e) {
                    B = a.slice(e).indexOf(")") +
            ...
            function n(a, c, d) {
                const e = (a, f) => {
                    ...
                    f = [];
                let b, B, g = 0;
                do b = e(a, g), B = a.substring(g, b && b.begin - 1), B.length && f.push({
                    value: B,
                    type: "constant"
                }), b && f.push({
                    value: b.statement,
                    type: "statement"
                }), g = b ? b.end + 1 : g + 1; while (b);
                f.forEach(a => {
    ...
    x(b, "Accessibility/Utils/ChartUtilities.js", [b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function (b, r, q) {
        ...
        function v(a) {
            if (a.points && a.points.length) return (a = c(a.points, a => !!a.graphic)) && a.graphic && a.graphic.element
        }
        ...
        function n(a, c) {
            ...
            c !== a.renderTo &&
                c.parentNode && c.parentNode !== k.body && (Array.prototype.forEach.call(c.parentNode.childNodes, function (a) {
    ...
    x(b, "Accessibility/KeyboardNavigationHandler.js", [b["Core/Utilities.js"]], function (b) {
        ...
        class q {
            ...
            run(b) {
                ...
                l ? q = l[1].call(this,
                    m, b) : 9 === m && (q = this.response[b.shiftKey ? "prev" : "next"]);
                return q
            }
        }
        "";
    ...
    x(b, "Accessibility/Components/ContainerComponent.js", [b["Accessibility/AccessibilityComponent.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function (b, r, q, l, m) {
        ...
        class k extends b {
            ...
            setRenderToAttrs() {
                ...
                c && (b.renderTo.setAttribute("role", a ? "region" : "group"), b.renderTo.setAttribute("aria-label",
                    c))
            }
    ...
    x(b, "Accessibility/FocusBorder.js", [b["Core/Renderer/SVG/SVGLabel.js"],
        ...
        (function (m) {
            ...
            function z(a, c) {
                ...
                (c = c || a.element) && c.focus && (c.hcEvents && c.hcEvents.focusin || q(c, "focusin", function () {}), c.focus(),
            ...
            function k(a, c) {
                ...
                if ("text" === this.element.nodeName || t) {
                    ...
                    isNaN(c) || (A = c - d.height *
                        p.y - f);
                    t && a && (t = y, y = h, h = t, isNaN(C) || (k = C - d.height * p.x - f), isNaN(c) || (A = c - d.width * p.y - f))
                }
            ...
            const d = [],
                e =
                "x y transform width height r d stroke-width".split(" ");
            m.compose = function (c, b) {
                r.pushUnique(d, c) && (c = c.prototype, c.renderFocusBorder = u, c.setFocusToElement = z);
                r.pushUnique(d, b) && (b = b.prototype, b.addFocusBorder = k, b.removeFocusBorder = a)
            }
        })(m || (m = {}));
        return m
    });
    ...
    x(b, "Accessibility/Components/InfoRegionsComponent.js", [b["Accessibility/A11yI18n.js"],
        b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/Announcer.js"], b["Accessibility/Components/AnnotationsA11y.js"], b["Core/Renderer/HTML/AST.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Templating.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]
        ...
        function g(a, b) {
            ...
            p = {
                ...
                chart: a,
                mapTitle: a.mapView && a.mapView.geoMap &&
                    a.mapView.geoMap.title
            };
            if (!c) return a.langFormat("accessibility.chartTypes.emptyChart", p);
            if ("map" === c || "tiledwebmap" === c) return p.mapTitle ? a.langFormat("accessibility.chartTypes.mapTypeDescription", p) : a.langFormat("accessibility.chartTypes.unknownMap", p);
            if (1 < a.types.length) return a.langFormat("accessibility.chartTypes.combinationChart", p); {
                b = b[0];
                c = a.langFormat("accessibility.seriesTypeDescriptions." + b, p);
                const d = a.series && 2 > a.series.length ? "Single" : "Multiple";
                a = (a.langFormat("accessibility.chartTypes." +
                    b + d, p) || a.langFormat("accessibility.chartTypes.default" + d, p)) + (c ? " " + c : "")
            }
            return a
        }
        const {
            getAnnotationsInfoHTML: a
        } = l, {
        ...
        class t extends r {
            ...
            setLinkedDescriptionAttrs() {
                ...
                a && (a.setAttribute("aria-hidden", "true"), J(a, "highcharts-linked-description"))
            }
            updateScreenReaderSection(a) {
                ...
                d ? (this.setScreenReaderSectionAttribs(h, a), m.setElementHTML(p, d), h.appendChild(p), c.insertIntoDOM(h, b), b.styledMode ? J(p, "highcharts-visually-hidden") : A(p), f(b, p), c.afterInserted && c.afterInserted()) : (h.parentNode &&
                ...
                const b = this.sonifyButton = v(a),
                    ...
                    d = a => {
                        b && (b.setAttribute("aria-hidden",
                            "true"), b.setAttribute("aria-label", ""));
                        a.preventDefault();
                        a.stopPropagation();
                        ...
                        setTimeout(() => {
                            b && (b.removeAttribute("aria-hidden"), b.removeAttribute("aria-label"));
                            c.sonify && c.sonify()
                        }, 1E3)
                    };
                b && c && (b.setAttribute("tabindex", -1), b.onclick = function (a) {
        ...
        function (b, r, q, l, m, u) {
            ...
            class g extends q {
                ...
                proxyMenuButton() {
                    ...
                    e &&
                        d && (this.exportButtonProxy = b.addProxyElement("chartMenu", {
                            click: d
                        }, {
                ...
                onKbdClick(a) {
                    ...
                    b.openMenu ? this.fakeClickEvent(d) : (this.fakeClickEvent(e), b.highlightExportItem(0));
                    return a.response.success
                }
            }(function (a) {
                function c() {
                    var a = this.exportSVGElements &&
                        this.exportSVGElements[0];
    ...
    x(b, "Accessibility/KeyboardNavigation.js", [b["Core/Globals.js"], b["Accessibility/Components/MenuComponent.js"], b["Core/Utilities.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function (b, r, q, l, m) {
        ...
        class a {
            ...
            onFocus(a) {
                ...
                !(b = (b = b.options.accessibility) && b.keyboardNavigation) || !b.enabled || this.exiting || this.tabbingInBackwards || this.isClickingChart || a || (a = this.getFirstValidModuleIx(), null !== a && (this.currentModuleIx = a, this.modules[a].init(1)));
                this.exiting = !1
            }
            onMouseUp(a) {
                ...
                if (!this.keyboardReset && a.relatedTarget !== g) {
                    const b = this.chart;
                    a.target && b.container.contains(a.target) || ((a = this.modules && this.modules[this.currentModuleIx || 0]) && a.terminate &&
                        a.terminate(), this.currentModuleIx = 0);
                    b.focusElement && (b.focusElement.removeFocusBorder(), delete b.focusElement);
            ...
            updateContainerTabindex() {
                ...
                const b = this.chart;
                var e = b.container;
                b.renderTo.hasAttribute("tabindex") && (e.removeAttribute("tabindex"), e = b.renderTo);
    ...
    x(b, "Accessibility/Components/LegendComponent.js", [b["Core/Animation/AnimationUtilities.js"],
        b["Core/Globals.js"], b["Core/Legend/Legend.js"], b["Core/Utilities.js"], b["Accessibility/AccessibilityComponent.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"]
        ...
        function k(a, b) {
            ...
            for (const h of ["group", "label", "symbol"])(b = (b = c[h]) && b.element || b) && d(b, a ? "mouseover" : "mouseout")
        }
        const {
            animObject: g
        } = b, {
        ...
        class G extends m {
            ...
            updateLegendItemProxyVisibility() {
                ...
                (b.allItems || []).forEach(h => {
                    if (h.a11yProxyElement) {
                        ...
                        var p = !1;
                        f = h.legendItem || {};
                        e && (h = f.pageIx || 0, e = f.y || 0, p = f.label ? Math.round(f.label.getBBox().height) : 0, p = e + p - b.pages[h] > d || h !== c - 1);
                        p ? a.styledMode ? I(w, "highcharts-a11y-invisible") : w.style.visibility = "hidden" : (x(w, "highcharts-a11y-invisible"), w.style.visibility =
                            "")
                    }
                })
            }
            ...
            highlightAdjacentLegendPage(a) {
                ...
                if (0 < a && a <= d.length) {
                    d = 0;
                    for (const h of c.allItems)((h.legendItem || {}).pageIx || 0) + 1 === a && (c = b.highlightLegendItem(d)) && (this.highlightedLegendItemIx = d), ++d
                }
            }
            ...
            onKbdArrowKey(a, b) {
                ...
                if (f.highlightLegendItem(this.highlightedLegendItemIx + b)) return this.highlightedLegendItemIx +=
                    b, d.success;
            ...
            function b(a) {
                ...
                const h = b[a];
                var d = h.legendItem || {};
                return h ? (e(c) && b[c] && k(!1, b[c]), b = this.legend, a = (b.allItems[a].legendItem || {}).pageIx, c = b.currentPage, "undefined" !== typeof a && a + 1 !== c && b.scroll(1 + a - c), d = d.label, a = h.a11yProxyElement && h.a11yProxyElement.buttonElement, d && d.element && a && this.setFocusToElement(d, a), k(!0, h), !0) : !1
            }
    ...
    x(b, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [b["Accessibility/Components/AnnotationsA11y.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Templating.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function (b, r, q, l, m) {
        function u(a) {
            const b = a.index;
            return a.series &&
                a.series.data && K(b) ? t(a.series.data, function (a) {
        ...
        function d(a) {
            ...
            if (d) {
                ...
                (p = p.xAxis && p.xAxis.dateTime) ? (p = p.getXDateFormat(a.x || 0, t.options.tooltip.dateTimeLabelFormats), C = C.dateFormatter && C.dateFormatter(a) || w.dateFormatter && w.dateFormatter(a) || C.dateFormat || w.dateFormat || p, t = t.time.dateFormat(C, a.x || 0, void 0)) : t = void 0;
                C =
                    (a.series.xAxis || {}).categories && K(a.category) && ("" + a.category).replace("<br/>", " ");
            ...
            t = K(a.index) ? a.index + 1 : ""; {
                ...
                g = k(a, a["undefined" !== typeof a.value ?
                    "value" : "y"]);
            ...
            (b || c) && a.points.forEach(c => {
                ...
                if (!(e = c.graphic && c.graphic.element)) {
                    ...
                    if (e = c.isNull && !p && e) {
                        ...
                        t = c.series.chart.renderer.rect(t.x, t.y,
                            1, 1);
                        t.attr({
                        ...
                        p && p.element ? (c.graphic = t, c.hasMockGraphic = !0, t.add(p), p.element.insertBefore(t.element, e ? e.element : null), e = t.element) : e = void 0
                    }
                }
                p = c.options && c.options.accessibility && !1 === c.options.accessibility.enabled;
                if (e)
                    if (c.isNull && !f) e.setAttribute("aria-hidden", !0);
                    else if (e.setAttribute("tabindex", "-1"), a.chart.styledMode || (e.style.outline = "none"), b && !p) {
                    var w, y, g;
                    p = c.series;
                    t = (null === (w = p.options.accessibility) ||
                        void 0 === w ? void 0 : w.point) || {};
        ...
        return {
            ...
            describeSeries: function (a) {
                ...
                if (d) {
                    ...
                    b ? (b = a.chart.options.accessibility, c = b.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? d.setAttribute("role", "img") : "all" === c ? d.setAttribute("role", "region") : d.setAttribute("role", "group"), d.setAttribute("tabindex",
        ...
        class d {
            ...
            announceDirtyData() {
                ...
                if (this.chart.options.accessibility.announceNewData && this.dirty.hasDirty) {
                    ...
                    b && (b = v(b));
                    this.queueAnnouncement(Object.keys(this.dirty.allSeries).map(b => a.dirty.allSeries[b]), this.dirty.newSeries,
                        b);
                    this.dirty = {
                        allSeries: {}
                    }
            ...
            queueAnnouncement(a, b, c) {
                ...
                if (d.enabled) {
                    ...
                    if (b = this.buildAnnouncementMessage(a, b, c)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
                        ...
                        this && this.announcer && (this.lastAnnouncementTime = +new Date, this.announcer.announce(this.queuedAnnouncement.message), delete this.queuedAnnouncement, delete this.queuedAnnouncementTimer)
                    }, d)
                }
            }
            buildAnnouncementMessage(d, f, k) {
                ...
                if (n.announcementFormatter && (d = n.announcementFormatter(d, f, k), !1 !== d)) return d.length ? d : null;
                d = b.charts && 1 < b.charts.length ? "Multiple" : "Single";
                d = f ? "newSeriesAnnounce" + d : k ? "newPointAnnounce" + d : "newDataAnnounce";
                n = g(e);
                return e.langFormat("accessibility.announceNewData." +
                    d, {
                        chartTitle: n,
    ...
    x(b, "Accessibility/ProxyElement.js", [b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function (b, r, q, l, m) {
        ...
        class e {
            constructor(a, b, c, d) {
                ...
                f ? (c && !a.styledMode && (f.style.listStyle = "none"), f.appendChild(e), this.element = f) : this.element = e;
    ...
    x(b, "Accessibility/ProxyProvider.js", [b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/DOMElementProvider.js"],
        b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/ProxyElement.js"]
    ], function (b, r, q, l, m, u) {
        const {
            doc: v
        } = b, {
        ...
        class c {
            ...
            addGroup(a, b, c) {
                ...
                let e;
                c && c.role && "div" !== b ? (e = this.domElementProvider.createElement("div"), e.appendChild(d)) : e = d;
            ...
            updateGroupAttrs(a, b) {
                ...
                if (!c) throw Error("ProxyProvider.updateGroupAttrs: Invalid group key " + a);
                z(c.groupElement, b)
            }
            updateGroupOrder(b) {
            ...
            clearGroup(b) {
                ...
                if (!c) throw Error("ProxyProvider.clearGroup: Invalid group key " + b);
    ...
    x(b, "Stock/RangeSelector/RangeSelectorComposition.js", [b["Core/Defaults.js"], b["Stock/RangeSelector/RangeSelectorDefaults.js"], b["Core/Utilities.js"]], function (b, r, q) {
        function l() {
            ...
            let f, g;
            B(a) ? (f = c - a, g = a) : a && (f = c + e(c, -(a.count || 1)), this.chart && (this.chart.fixedRange = c - f));
            const w = I(this.dataMin, Number.MIN_VALUE);
            B(f) || (f = w);
            f <= w && (f = w, "undefined" === typeof g && (g = e(f, a.count)), this.newMax = Math.min(f + g, I(this.dataMax, Number.MAX_VALUE)));
        ...
        function u() {
            ...
            b && (B(b.deferredYTDClick) && (b.clickButton(b.deferredYTDClick), delete b.deferredYTDClick), a.forEach(a => {
                a.updateNames();
                a.setScale()
        ...
        function g(a) {
            ...
            b && b.enabled && !e(d) && this.options.rangeSelector && (this.options.rangeSelector.enabled = !0, this.rangeSelector =
                d = new A(this));
            this.extraTopMargin = this.extraBottomMargin = !1;
            d && (v(this), b = b && b.verticalAlign || d.options && d.options.verticalAlign, d.options.floating || ("bottom" === b ? this.extraBottomMargin = !0 : "middle" !== b && (this.extraTopMargin = !0)), this.extraBottomMargin !== a || this.extraTopMargin !== c) && (this.isDirtyBox = !0)
        }
        const {
            defaultOptions: a,
            setOptions: c
        ...
        return {
            compose: function (b, h, e) {
                A = e;
                q.pushUnique(G, b) && (b.prototype.minFromRange =
                    l);
    ...
    x(b, "Stock/RangeSelector/RangeSelector.js", [b["Core/Axis/Axis.js"], b["Core/Defaults.js"], b["Core/Globals.js"], b["Stock/RangeSelector/RangeSelectorComposition.js"], b["Core/Renderer/SVG/SVGElement.js"], b["Core/Utilities.js"]], function (b, r, q, l, m, u) {
        ...
        class y {
            ...
            clickButton(c, d) {
                ...
                let y = g.dataMin,
                    m = g.dataMax,
                    q, D = t && Math.round(Math.min(t.max, F(m, t.max))),
                    l;
                g = e._range;
                let r, u, v, z = !0;
                if (null !== y && null !== m) {
                    h.fixedRange = g;
                    this.setSelected(c);
                    k && (this.forcedDataGrouping = !0, b.prototype.setDataGrouping.call(t || {
                            chart: this.chart
                        }, k, !1), this.frozenStates =
                        e.preserveDataGrouping);
                    if ("month" === w || "year" === w) t ? (w = {
                        range: e,
                        max: D,
                        chart: h,
                        dataMin: y,
                        dataMax: m
                    }, q = t.minFromRange.call(w), E(w.newMax) && (D = w.newMax), z = !1) : g = e;
                    else if (g) q = Math.max(D - g, y), D = Math.min(q + g, m), z = !1;
                    else if ("ytd" === w)
                        if (t) {
                            if ("undefined" === typeof m || "undefined" === typeof y) y = Number.MAX_VALUE, m = Number.MIN_VALUE, h.series.forEach(a => {
                                if (a = a.xData) y = Math.min(a[0], y), m = Math.max(a[a.length - 1], m)
                            }), d = !1;
                        ...
                        w && t && (h.navigator && h.navigator.baseSeries[0] && (h.navigator.baseSeries[0].xAxis.options.range = void 0), q = y, D = m);
                    ...
                    }) : (l = A(h.options.xAxis)[0], v = l.range, l.range = g, u = l.min, l.min = r, n(h, "load", function () {
                        l.range = v;
                        l.min = u
                    }));
            ...
            init(a) {
                ...
                this.eventsToUnbind.push(n(a, "load", function () {
                    a.xAxis &&
                        a.xAxis[0] && n(a.xAxis[0], "setExtremes", function (c) {
            ...
            updateButtonStates() {
                ...
                a.buttonOptions.forEach((b, h) => {
                    ...
                    ("month" === t || "year" === t) && e + 36E5 >= 864E5 * {
                        ...
                        month: 31,
                        year: 366
                    } [t] * g + w ? p = !0 : "ytd" === t ? (p = m - y + w === e, r = !H) : "all" === t && (p = d.max - d.min >= n - k, u = !H && l && p);
                    t = !A && (K || M || u || f);
                    g = H && p || p && !l && !r || H && a.frozenStates;
                    t ? b = 3 : g && (l = !0, b = 2);
                    C.state !== b && (C.setState(b), c && (c.options[h + 1].disabled =
            ...
            setInputValue(b, c) {
                ...
                if (e) {
                    ...
                    a(c) && (a(f) && e.setAttribute("data-hc-time-previous", f), e.setAttribute("data-hc-time", c), f = c);
            ...
            defaultInputDateParser(a, b, c) {
                ...
                if (b) d += "Z";
                    ...
                    var h;
                    if (h = q.isSafari) h = d, h = !(6 < h.length &&
                        (h.lastIndexOf("-") === h.length - 6 || h.lastIndexOf("+") === h.length - 6));
                    h && (h = (new Date(d)).getTimezoneOffset() / 60, d += 0 >= h ? `+${I(-h)}:00` : `-${I(h)}:00`)
                }
                d = Date.parse(d);
                E(d) || (a = a.split("-"), d = Date.UTC(G(a[0]), G(a[1]) - 1, G(a[2])));
            ...
            drawInput(a) {
                function b() {
                    ...
                    g !== Number(D.getAttribute("data-hc-time-previous")) &&
                        E(g) && (D.setAttribute("data-hc-time-previous", g), m && b && E(p) ? g > Number(b.getAttribute("data-hc-time")) ? g = void 0 : g < p && (g = p) : d && E(e) && (g < Number(d.getAttribute("data-hc-time")) ? g = void 0 : g > e && (g = e)), "undefined" !== typeof g && h.setExtremes(m ? g : h.min, m ? h.max : g, void 0, void 0, {
                ...
                const {
                    ...
                    div: d,
                    inputGroup: h
                } = this, f = this, w = c.renderer.style || {};
                var n = c.renderer;
                ...
                c.styledMode || (A.css(B(w, y.labelStyle)), n.css(B({
                        color: "#333333"
                    },
                    w, y.inputStyle)), g(D, e({
                    position: "absolute",
                    border: 0,
            ...
            render(b, c) {
                ...
                if (!1 !== g.enabled) {
                    this.rendered || (this.group = e.g("range-selector-group").attr({
                        ...
                        height: 0,
                        zIndex: t
                    }), this.buttonOptions.length && this.renderButtons(), h.parentNode && h.parentNode.insertBefore(this.div, h), f && (this.inputGroup = e.g("input-group").add(this.group), e = this.drawInput("min"), this.minDateBox = e.dateBox, this.minLabel = e.label, this.minInput = e.input,
                        e = this.drawInput("max"), this.maxDateBox = e.dateBox, this.maxLabel = e.label, this.maxInput = e.input));
                    if (f && (this.setInputValue("min", b), this.setInputValue("max", c), b = d.scroller && d.scroller.getUnionExtremes() || d.xAxis[0] || {}, a(b.dataMin) && a(b.dataMax) && (d = d.xAxis[0].minRange || 0, this.setInputExtremes("min", b.dataMin, Math.min(b.dataMax, this.getInputValue("max")) - d), this.setInputExtremes("max", Math.max(b.dataMin, this.getInputValue("min")) + d, b.dataMax)), this.inputGroup)) {
                        let a = 0;
                        [this.minLabel, this.minDateBox,
                            this.maxLabel, this.maxDateBox
                        ].forEach(b => {
                            if (b) {
                                const {
                                    width: c
            ...
            renderButtons() {
                const {
                    ...
                    chart: b,
                    options: c
                } = this, d = z.lang, e = b.renderer, g = B(c.buttonTheme), w = g && g.states, y = g.width || 28;
                delete g.width;
                delete g.states;
                ...
                this.chart.styledMode || (this.zoomText.css(c.labelStyle), g["stroke-width"] = F(g["stroke-width"],
                    0));
                k("option", {
            ...
            alignElements() {
                ...
                if (d && y && m) {
                    ...
                    r = 0;
                    e && (r = k(e, m), "left" === m.align ? l = q : "right" === m.align && (l = -Math.max(c.axisOffset[1], -r)), e.align({
                        y: m.y,
                        width: e.getBBox().width,
                        align: m.align,
                        x: m.x + l - 2
                    }, !0, c.spacingBox), e.placed = c.hasLoaded);
                    ...
                    l = 0;
                    "bottom" ===
                    A && (l = (l = c.legend && c.legend.options) && "bottom" === l.verticalAlign && l.enabled && !l.floating ? c.legend.legendHeight + F(l.margin, 10) : 0, q = q + l - 20, l = k - q - (f.floating ? 0 : f.y) - (c.titleOffset ? c.titleOffset[2] : 0) - 10);
                    if ("top" === A) f.floating && (l = 0), c.titleOffset && c.titleOffset[0] && (l = c.titleOffset[0]), l += c.margin[0] - c.spacing[0] || 0;
                    else if ("middle" === A)
                        if (m.y === y.y) l = k;
                        else if (m.y || y.y) l = 0 > m.y || 0 > y.y ? l - Math.min(m.y, y.y) : k - q;
                    ...
                    f.inputEnabled &&
                        h && p && (h.style.marginTop = d.translateY + "px", p.style.marginTop = d.translateY + "px");
            ...
            positionButtons() {
                ...
                for (let b = 0, d = this.buttonOptions.length; b < d; ++b)
                    if ("hidden" !== a[b].visibility) a[b][e]({
                        x: k
            ...
            handleCollision(a) {
                const {
                    ...
                    if (d && c) {
                        const f =
                            d.alignAttr.translateX + d.alignOptions.x - a + d.getBBox().x + 2,
            ...
            collapseButtons(a) {
                const {
                    ...
                    options: f,
                    zoomText: h
                } = this, g = d.userOptions.rangeSelector && d.userOptions.rangeSelector.buttonTheme || {}, k = a => ({
                    text: a ? `${a} ▾` : "▾",
                    width: "auto",
                ...
                n || (e && (e.selectedIndex = 0), b[0].show(), b[0].attr(k(this.zoomText && this.zoomText.textStr)));
                const {
                    align: m
                } = f.buttonPosition;
                this.positionButtons();
            ...
            showDropdown() {
                ...
                if (a && d) {
                    const {
                        translateX: e,
                        translateY: f
                    } = a, h = b[this.currentButtonIndex()].getBBox();
                    g(d, {
    ...
    x(b, "Accessibility/Components/RangeSelectorComponent.js", [b["Stock/RangeSelector/RangeSelector.js"], b["Accessibility/AccessibilityComponent.js"],
        b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/Announcer.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Core/Utilities.js"]
    ], function (b, r, q, l, m, u) {
        const {
            unhideChartElementFromAT: v,
            getAxisRangeDescription: z
        } = q, {
            addEvent: n,
            attr: k
        } = u;
        class g extends r {
            ...
            onChartUpdate() {
                const a = this.chart,
                    b = this,
                    d = a.rangeSelector;
                d && (this.updateSelectorVisibility(), this.setDropdownAttrs(),
                    d.buttons && d.buttons.length && d.buttons.forEach(a => {
                        ...
                        if (c = d[c]) v(a, c), b.setRangeInputAttrs(c, "accessibility.rangeSelector." + (f ? "max" : "min") + "InputLabel")
                    }))
            }
            updateSelectorVisibility() {
                const a = this.chart,
                    ...
                    d = b && b.dropdown,
                    e = b && b.buttons || [];
                b && b.hasVisibleDropdown && d ? (v(a, d), e.forEach(a => a.element.setAttribute("aria-hidden", !0))) : (d && d.setAttribute("aria-hidden", !0), e.forEach(b => v(a, b.element)))
            }
            setDropdownAttrs() {
                var a =
                    this.chart;
            ...
            onButtonNavKbdArrowKey(a, b) {
                ...
                return f.highlightRangeSelectorButton(f.highlightedRangeSelectorItemIx + b) ? c.success : g ? (a.init(b), c.success) : c[0 < b ? "next" : "prev"]
            }
            ...
            onInputKbdMove(a) {
                ...
                if (1 < e || 0 > e) {
                    if (b.accessibility) return b.accessibility.keyboardNavigation.exiting = !0, b.accessibility.keyboardNavigation.tabindexContainer.focus(), b.accessibility.keyboardNavigation.move(a)
                } else d && (a = d[e ? "maxDateBox" : "minDateBox"], d = d[e ? "maxInput" : "minInput"], a && d && b.setFocusToElement(a, d));
                return !0
            }
            onInputNavInit(a) {
                const b = this;
                ...
                if (g && a && f) {
                    ...
                    d = a => {
                        (a.which || a.keyCode) === this.keyCodes.tab && b.onInputKbdMove(a.shiftKey ? -1 : 1) && (a.preventDefault(), a.stopPropagation())
                    };
            ...
            initDropdownNav() {
                const a = this.chart,
                    b = a.rangeSelector,
                    d = b && b.dropdown;
                b && d && (a.setFocusToElement(b.buttonGroup, d), this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(), this.removeDropdownKeydownHandler = n(d, "keydown", b => {
                    const c = a.accessibility;
                    (b.which || b.keyCode) === this.keyCodes.tab && (b.preventDefault(), b.stopPropagation(),
    ...
    x(b, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [b["Core/Utilities.js"]], function (b) {
        ...
        (function (m) {
            ...
            function k() {
                var a = this.options,
                    b = !1 !== (this.options.accessibility &&
                        this.options.accessibility.enabled);
                if (b = this.chart.options.accessibility.enabled && b) b = this.chart.options.accessibility, b = this.points.length < b.series.pointDescriptionEnabledThreshold || !1 === b.series.pointDescriptionEnabledThreshold;
                if (b) {
                    if (a.marker && !1 === a.marker.enabled && (this.a11yMarkersForced = !0, l(this.options)), this._hasPointMarkers && this.points && this.points.length)
                        for (a = this.points.length; a--;) {
                            ...
                            c.marker &&
                                (d = d && 0 === v(c), c.marker.enabled && !d ? (q(!0, c.marker, {
                                    states: {
                                        normal: {
                                            opacity: v(c) || 1
                                        }
                                    }
                                }), b.hasForcedA11yMarker = !1) : !1 === c.marker.enabled && (l(c), b.hasForcedA11yMarker = !0))
                        }
    ...
    x(b, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js", [b["Core/Series/Point.js"], b["Core/Series/Series.js"], b["Core/Series/SeriesRegistry.js"], b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/ChartUtilities.js"]], function (b, r, q, l, m, u, x, z) {
        ...
        function c(a) {
            let b = a.series.length,
                c = !1;
            for (; b-- && !(a.highlightedPoint = a.series[b].points[a.series[b].points.length - 1], c = a.series[b].highlightNextValidPoint()););
            return c
        }
        ...
        class G {
            ...
            getKeyboardNavigationHandler() {
                ...
                return new u(f, {
                    keyCodeMap: [
                        [g ? [e.up, e.down] : [e.left, e.right], function (a) {
                        ...
                        [
                            [e.enter, e.space],
                            function (a, b) {
                                if (a = f.highlightedPoint) b.point = a, B(a.series, "click", b), a.firePointEvent("click");
                                return this.response.success
                            }
                        ],
                        [
            ...
            onHandlerInit(a) {
                const b = this.chart;
                b.options.accessibility.keyboardNavigation.seriesNavigation.rememberPointFocus && b.highlightedPoint ? b.highlightedPoint.highlight() :
                    d(b);
                return a.response.success
            }
            onKbdVertical(a, b) {
            ...
            function b(a) {
                ...
                return g(d) ? (b = d.series, k(b) ? this.highlightedPoint = a ? b.points[b.points.length - 1] : b.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(a)) : d.highlight()
            }
                ...
                this.series.forEach(e => {
                    k(e) || e.points.forEach(f => {
                        if (v(f.plotY) && v(f.plotX) && f !== b) {
                            ...
                            !(0 >= k && a || 0 <= k && !a || 5 > h || g(f)) && h < c && (c = h, d = f)
                        }
                    })
                });
            ...
            function d(a) {
                ...
                d = f(b, c, 4);
                if (!d) return !1;
                if (k(c)) return d.highlight(), a = this.highlightAdjacentSeries(a),
                    a ? a : (b.highlight(), !1);
                d.highlight();
            ...
            function f(a, b, c, d) {
                ...
                if (!k(a)) {
                    for (; g--;) {
                        var h = b.points[g];
                        k(h) || (h = (a.plotX - h.plotX) * (a.plotX - h.plotX) * (c || 1) + (a.plotY - h.plotY) * (a.plotY - h.plotY) * (d || 1), h < e && (e = h, f = g))
                    }
            ...
            function q() {
                ...
                if (a && c) {
                    for (let d = b; d < c; ++d)
                        if (!g(a[d])) return a[d].highlight();
                    for (; 0 <= b; --b)
                        if (!g(a[b])) return a[b].highlight()
                }
                return !1
            }
            const r = [];
            a.compose = function (a, f, g) {
                m.pushUnique(r, a) && (a = a.prototype, a.highlightAdjacentPoint = b, a.highlightAdjacentPointVertical = c, a.highlightAdjacentSeries = d);
                m.pushUnique(r,
                    f) && (f.prototype.highlight = l);
                m.pushUnique(r, g) && (f = g.prototype, f.keyboardMoveVertical = !0, ["column", "gantt", "pie"].forEach(a => {
    ...
    x(b, "Accessibility/Components/SeriesComponent/SeriesComponent.js", [b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Components/SeriesComponent/ForcedMarkers.js"], b["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"],
        b["Accessibility/Components/SeriesComponent/SeriesDescriber.js"], b["Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js"]
    ], function (b, r, q, l, m, u) {
        const {
            hideSeriesFromAT: v
        } = r, {
        ...
        class k extends b {
            ...
            onChartUpdate() {
                ...
                b.mapNavigation && b.mapNavigation.navButtons.forEach((c, d) => {
                    v(b, c.element);
                    a.setMapNavButtonAttrs(c.element, "accessibility.zoom.mapZoom" +
                        (d ? "Out" : "In"))
                })
            }
            ...
            updateProxyOverlays() {
                ...
                b.drillUpButton && b.breadcrumbs && b.breadcrumbs.list && this.createZoomProxyButton(b.drillUpButton,
                    "drillUpProxyButton", b.langFormat("accessibility.drillUpButton", {
                        chart: b,
    ...
    x(b, "Accessibility/HighContrastMode.js", [b["Core/Globals.js"]], function (b) {
        ...
        return {
            isHighContrastModeActive: function () {
                ...
                if (l.matchMedia && b) return l.matchMedia("(-ms-high-contrast: active)").matches;
    ...
    x(b, "Accessibility/Options/DeprecatedOptions.js", [b["Core/Utilities.js"]], function (b) {
        ...
        function q(b, k, g, a) {
            ...
            Object.keys(a).forEach(function (c) {
                const f = d[c];
                "undefined" !== typeof f && (r(e, a[c], f), x(32, !1, b, {
        ...
        function v(b) {
            ...
            b.series.forEach(function (g) {
                Object.keys(k).forEach(function (a) {
                    ...
                    "undefined" !== typeof c && (r(g.options, k[a], "skipKeyboardNavigation" === a ? !c : c), x(32, !1, b, {
    ...
    x(b, "Accessibility/Accessibility.js", [b["Core/Defaults.js"], b["Core/Globals.js"], b["Core/Utilities.js"],
        ...
        b["Accessibility/Components/SeriesComponent/SeriesComponent.js"], b["Accessibility/Components/ZoomComponent.js"], b["Accessibility/HighContrastMode.js"], b["Accessibility/HighContrastTheme.js"], b["Accessibility/Options/A11yDefaults.js"], b["Accessibility/Options/LangDefaults.js"], b["Accessibility/Options/DeprecatedOptions.js"]
        ...
        class C {
            constructor(a) {
                this.proxyProvider =
                    this.keyboardNavigation = this.components = this.chart = void 0;
                this.init(a)
            }
            init(a) {
                this.chart = a;
                v.addEventListener ? (F(a), this.proxyProvider = new c(this.chart), this.initComponents(), this.keyboardNavigation = new n(a, this.components)) : (this.zombie = !0, this.components = {}, a.renderTo.setAttribute("aria-hidden", !0))
            }
            initComponents() {
                const a = this.chart,
                    b = this.proxyProvider,
            ...
            destroy() {
                ...
                a.announcerContainer &&
                    p(a.announcerContainer);
            ...
            function h(a) {
                if (a = a.options.accessibility) a.customComponents && (this.options.accessibility.customComponents = a.customComponents, delete a.customComponents), t(!0, this.options.accessibility, a), this.accessibility && this.accessibility.destroy && (this.accessibility.destroy(), delete this.accessibility);
                this.a11yDirty = !0
            }
            ...
            function l() {
                ...
                c && c.enabled ? a && !a.zombie ? a.update() : (this.accessibility =
            ...
            b.compose = function (b, v, t, u, w, y) {
                ...
                x.compose(b, w);
                y && d.compose(b, y);
                q.pushUnique(r, b) && (b.prototype.updateA11yEnabled = l, A(b, "destroy", c), A(b, "render", f), A(b, "update", h),
    ...
    x(b, "masters/modules/accessibility.src.js", [b["Core/Globals.js"],
        b["Accessibility/Accessibility.js"], b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Components/SeriesComponent/SeriesDescriber.js"]
        ...
        r.compose(b.Chart, b.Legend, b.Point, b.Series,
