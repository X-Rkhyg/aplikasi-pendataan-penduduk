...
(function (a) {
    ...
    function e(a, l, y, F) {
        a.hasOwnProperty(l) || (a[l] = F.apply(null, y), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: l,
                module: a[l]
            }
    ...
    e(a, "Extensions/Exporting/ExportingSymbols.js", [], function () {
        ...
        (function (a) {
            ...
            const p = [];
            a.compose = function (a) {
                -1 === p.indexOf(a) && (p.push(a), a = a.prototype.symbols, a.menu = b, a.menuball = l.bind(a))
            }
        })(a || (a = {}));
        return a
    });
        ...
        const {
            ...
            ajax: function (a) {
                ...
                c.onreadystatechange = function () {
                    ...
                    if (4 === c.readyState) {
                        if (200 === c.status) {
                            if ("blob" !== a.responseType && (b = c.responseText, "json" === a.dataType)) try {
                                b = JSON.parse(b)
                            } catch (z) {
        ...
        (function (e) {
            function F(a) {
                ...
                if (!1 !== b.enabled && b.theme) {
                    ...
                    b.text && b.symbol ? v.paddingLeft = q(v.paddingLeft, 30) : b.text || H(v, {
                        width: b.width,
                        height: b.height,
                        padding: 0
                    });
                    f.styledMode || (v["stroke-linecap"] = "round", v.fill = q(v.fill, "#ffffff"), v.stroke = q(v.stroke, "none"));
                    var r = d.button(b.text, 0, 0, e, v, void 0, void 0, void 0, void 0, b.useHTML).addClass(a.className).attr({
                    ...
                    b.symbol && (x = d.symbol(b.symbol,
                        b.symbolX - n / 2, b.symbolY - n / 2, n, n, {
                            width: n,
                            height: n
                        }).addClass("highcharts-button-symbol").attr({
                        zIndex: 1
                    }).add(r), f.styledMode || x.attr({
                        stroke: b.symbolStroke,
                        fill: b.symbolFill,
                        "stroke-width": b.symbolStrokeWidth || 1
                    }));
                    r.add(f.exportingGroup).align(H(b, {
                        width: r.width,
                        x: q(b.x, f.buttonOffset)
                    }), !0, "spacingBox");
            ...
            function Y(b, f, c, e, g, E, n) {
                const d = this,
                    ...
                    K = Math.max(g, E);
                let u, h = d[l];
                h || (d.exportContextMenu = d[l] = h = G("div", {
                    className: b
                }, {
                    position: "absolute",
                    zIndex: 1E3,
                    padding: K +
                        "px",
                    pointerEvents: "auto"
                }, d.fixedDiv || d.container), u = G("ul", {
                    className: "highcharts-menu"
                }, d.styledMode ? {} : {
                    listStyle: "none",
                    margin: 0,
                    padding: 0
                }, h), d.styledMode || w(u, H({
                    MozBoxShadow: "3px 3px 10px #888",
                    WebkitBoxShadow: "3px 3px 10px #888",
                    boxShadow: "3px 3px 10px #888"
                }, t.menuStyle)), h.hideMenu = function () {
                    w(h, {
                        display: "none"
                    });
                    n && n.setState(0);
                    ...
                    if (T(b, !0)) {
                        ...
                        }, void 0, u), a.setElementHTML(f, b.text || d.options.lang[b.textKey]), d.styledMode || (f.onmouseover = function () {
            ...
            function Z(a) {
                ...
                let e;
                d && (d.forEach((a, f) => {
                    a && (a.onclick = a.ontouchstart = null, e = "cache-" + a.menuClassName, b[e] && delete b[e], d[f] = a.destroy())
                }), d.length = 0);
                b.exportingGroup && (b.exportingGroup.destroy(),
                    delete b.exportingGroup);
                c && (c.forEach(function (a, b) {
                    a && (m.clearTimeout(a.hideTimer), V(a, "mouseleave"), c[b] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null, N(a))
                }), c.length = 0);
            ...
            function da(a) {
                ...
                this.axes.forEach(function (a) {
                    ...
                    a.options.isInternal || (n[a.coll] || (n[a.coll] = !0, d[a.coll] = []), d[a.coll].push(k(a.userOptions, {
                        visible: a.visible
                    })))
                });
