'use strict';
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/series-label", ["highcharts"], function (x) {
        a(x);
        a.Highcharts = x;
        return a
    ...
    function x(a, q, C, f) {
        a.hasOwnProperty(q) || (a[q] = f.apply(null, C), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: q,
                module: a[q]
            }
    ...
    x(a, "Extensions/SeriesLabel/SeriesLabelUtilities.js", [], function () {
        ...
        function q(C, f, q, y, m, w, A, B) {
            return a(C, f, m, w, A, B) !== a(q, y, m, w, A, B) &&
                a(C, f, q, y, m, w) !== a(C, f, q, y, A, B)
        }
        return {
    ...
    x(a, "Extensions/SeriesLabel/SeriesLabel.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Chart/Chart.js"], a["Core/Templating.js"], a["Core/Defaults.js"], a["Extensions/SeriesLabel/SeriesLabelDefaults.js"], a["Extensions/SeriesLabel/SeriesLabelUtilities.js"],
        a["Core/Utilities.js"]
    ], function (a, q, x, f, P, y, m) {
        function w(t, a, r, b, k) {
            ...
            for (z = 0; z < d.series.length; z += 1) {
                ...
                if (F.visible && c) {
                    ...
                    for (D = d.plotTop; D <= d.plotTop +
                        d.plotHeight; D += l) c.unshift({
                        chartX: d.plotLeft,
                        chartY: D
                    }), c.push({
        ...
        function A(a) {
            ...
            a.series.forEach(b => (b.points || []).forEach(a => (a.dataLabels || []).forEach(a => {
                const {
                    width: d,
                    height: k
                } = a.getBBox(), g = a.translateX + (b.xAxis ? b.xAxis.pos : b.chart.plotLeft);
            ...
            a.series.forEach(function (b) {
                ...
                if (d && (b.xAxis || b.yAxis)) {
                    var h = "highcharts-color-" + E(b.colorIndex, "none"),
                        t = !b.labelBySeries,
                        g = d.minFontSize,
                        c = d.maxFontSize,
                        e = a.inverted,
                        r = e ? b.yAxis.pos : b.xAxis.pos,
                        n = e ? b.xAxis.pos : b.yAxis.pos,
                        f = a.inverted ? b.yAxis.len : b.xAxis.len,
                        q = a.inverted ? b.xAxis.len : b.yAxis.len,
                        u = b.interpolatedPoints,
                        z = E(d.onArea, !!b.area),
                        l = [],
                        m = b.xData || [],
                        p, v = b.labelBySeries;
                    ...
                    if (b.visible && !b.boosted && u) {
                        ...
                        for (e = u.length - 1; 0 < e; --e) z ? (c = u[e].chartX - g.width / 2, h = (u[e].chartCenterY || 0) - g.height / 2, k(c, h, g) && (p = w(b, c, h, g))) : (c = u[e].chartX + 3, h = u[e].chartY - g.height - 3, k(c, h, g) && (p = w(b, c, h, g, !0)), p && l.push(p), c = u[e].chartX + 3, h = u[e].chartY + 3, k(c, h, g) && (p = w(b, c, h, g, !0)), p && l.push(p), c = u[e].chartX - g.width - 3, h = u[e].chartY + 3, k(c, h, g) && (p = w(b,
                            c, h, g, !0)), p && l.push(p), c = u[e].chartX - g.width - 3, h = u[e].chartY - g.height - 3, k(c, h, g) && (p = w(b, c, h, g, !0))), p && l.push(p);
                        if (d.connectorAllowed && !l.length && !z)
                            for (c = r + f - g.width; c >= r; c -= 16)
                                for (h = n; h < n + q - g.height; h += 16)(p = w(b, c, h, g, !0)) && l.push(p);
                        if (l.length) {
                            if (l.sort((b, a) => a.weight - b.weight), p = l[0], (a.boxesToAvoid || []).push({
                                    left: p.x,
                                    right: p.x + g.width,
                                    top: p.y,
                                    bottom: p.y + g.height
                                ...
                                let c;
                                t && (c = I(b.options.animation), c.duration *= .2);
                                ...
                                if (b = b.searchPoint({
                                        chartX: p.x,
                                        chartY: p.y
                                    }, !0)) v.closest = [b, p.x - (b.plotX || 0), p.y - (b.plotY || 0)]
                            }
        ...
        function B(a) {
            ...
            if (a.xAxis || a.yAxis) {
                ...
                if (a.getPointSpline && d && d.getPointAtLength && !f && r.length < (a.chart.plotSizeX || 0) / 16) {
                    ...
                    g = d.getTotalLength();
                    for (a = 0; a < g; a += 16) f = d.getPointAtLength(a), e({
                        chartX: c + f.x,
                        chartY: h + f.y,
                        plotX: f.x,
                        plotY: f.y
                    ...
                    for (g = r.length, a = 0; a < g; a += 1) {
                        ...
                        if (H(b) && H(g)) {
                            ...
                            f && (t && (k.plotY = t, k.chartY = h + t), k.chartCenterY = h + ((t ? t : g) + E(d.yBottom, q)) / 2);
                            if (n) {
            ...
            if (this.renderer) {
                ...
                e.series.forEach(function (b) {
                    const k = b.options.label || {},
                        d = b.labelBySeries,
                        h = d && d.closest;
                    k.enabled && b.visible && (b.graph || b.area) && !b.boosted && e.labelSeries && (e.labelSeries.push(b), k.minFontSize && k.maxFontSize && b.yData && (b.sum = b.yData.reduce((a, b) => (a || 0) + (b || 0), 0), e.labelSeriesMaxSum = Math.max(e.labelSeriesMaxSum || 0, b.sum || 0)), "load" === a.type && (f = Math.max(f, I(b.options.animation).duration)), h && ("undefined" !== typeof h[0].plotX ? d.animate({
                        x: h[0].plotX + h[1],
                        y: h[0].plotY + h[2]
                    }) : d.attr({
                        opacity: 0
        ...
        function O(a, e, f, b, k) {
            ...
            H(d) && H(k) && (h = [
                ["M", d, k]
            ], m = e - k, 0 > m && (m = -b - m), m < f && (g = d < a + f / 2 ? m : f - m), k > e + b ? h.push(["L", a + g, e + b]) : k < e ? h.push(["L", a + g, e]) : d < a ? h.push(["L", a, e + b / 2]) : d > a + f && h.push(["L", a + f, e + b / 2]));
            return h || []
        }
        const {
            animObject: I
